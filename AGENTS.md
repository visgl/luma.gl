...
- Before creating or moving a release tag, update [`CHANGELOG.md`](CHANGELOG.md), stage it with `git add CHANGELOG.md`, and commit it on the release branch. Use a heading that exactly matches the tag version (for example, `### v9.4.2`).
