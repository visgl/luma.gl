...
class AppAnimationLoop extends AnimationLoop {
  onInitialize({gl, canvas}) {
    ...
    const cubemap1 = new TextureCube(gl, {
      data: getFaceTextures({size: 256, bgColor: 'rgb(230,0,230)'})
    });
    const cubemap2 = new TextureCube(gl, {
      data: getFaceTextures({size: 256, bgColor: 'rgb(0,230,230)', text: 'cube'})
    });
