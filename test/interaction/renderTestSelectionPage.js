...
The following test pages can be used to test the legacy and new event handlers.
Events which are emitted are logged in the console.
After you are finished with a test, reload the page to return to this menu.
There is a bug in the legacy position calculations that provides incorrect positions if the document is scrolled,
though position caching may caching may make this seems like it works sometimes.
  `;
