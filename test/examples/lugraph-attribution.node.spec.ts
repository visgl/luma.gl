...
const SOURCE_DIRECTORY = new URL('../../modules/experimental/src/lugraph/', import.meta.url);
const DOCUMENTATION_URL = new URL(
  '../../docs/api-reference/experimental/lugraph.md',
  import.meta.url
);
...
describe('luGraph RAPIDS attribution', () => {
