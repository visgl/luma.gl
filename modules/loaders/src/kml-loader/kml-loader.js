...
export default class KmlReader {
  ...
  parse(callback) {
    this.parseDocuments(callback);
    this.parseFolders(callback);
    this.parseMarkers(callback);
    this.parsePolygons(callback);
    this.parseLines(callback);
    this.parseGroundOverlays(callback);
    this.parseNetworklinks(callback);
  }
