...
export function findGeometryColumnIndex(schema, extensionName, geometryColumnName) {
    const index = schema.fields.findIndex(field => field.name === geometryColumnName ||
 ...
 */
export function isColumnReference(input) {
...
export function convertStructToFixedSizeList(coords) {
 ...
 */
export function getGeometryVector(table, geoarrowTypeName) {
 ...
 *
 */
export function validateVectorAccessors(table, vectorAccessors) {
...
export function validateColorVector(vector) {
...
export function isPointVector(vector) {
    // Check FixedSizeList
...
export function isLineStringVector(vector) {
...
export function isPolygonVector(vector) {
    // Check the outer vector is a List
    if (!arrow.DataType.isList(vector.type)) {
        return false;
    }
...
export function isMultiPointVector(vector) {
    // Check the outer vector is a List
    if (!arrow.DataType.isList(vector.type)) {
        return false;
    }
...
export function isMultiLineStringVector(vector) {
    // Check the outer vector is a List
    if (!arrow.DataType.isList(vector.type)) {
        return false;
    }
...
export function isMultiPolygonVector(vector) {
    // Check the outer vector is a List
    if (!arrow.DataType.isList(vector.type)) {
        return false;
    }
...
export function validatePointType(type) {
...
export function validateLineStringType(type) {
...
export function validatePolygonType(type) {
    // Assert the outer vector is a List
    assert(arrow.DataType.isList(type));
...
export function validateMultiPointType(type) {
    // Assert the outer vector is a List
    assert(arrow.DataType.isList(type));
    // Assert its inner vector is a point layout
    validatePointType(type.children[0].type);
...
export function validateMultiLineStringType(type) {
    // Assert the outer vector is a List
    assert(arrow.DataType.isList(type));
    // Assert its inner vector is a linestring layout
    validateLineStringType(type.children[0].type);
...
export function validateMultiPolygonType(type) {
    // Assert the outer vector is a List
    assert(arrow.DataType.isList(type));
    // Assert its inner vector is a linestring layout
...
export function getPointChild(data) {
    // @ts-expect-error
    return data.children[0];
}
export function getLineStringChild(data) {
    // @ts-expect-error
    return data.children[0];
}
export function getPolygonChild(data) {
    // @ts-expect-error
    return data.children[0];
}
export function getMultiPointChild(data) {
    // @ts-expect-error
    return data.children[0];
}
export function getMultiLineStringChild(data) {
    // @ts-expect-error
    return data.children[0];
}
export function getMultiPolygonChild(data) {
    // @ts-expect-error
    return data.children[0];
}
