# @luma.gl/experimental/gpu-crossfilter

GPU-resident, linked-view crossfiltering for luma.gl.

`GPUCrossfilter` coordinates interactive selections across maps, histograms, grouped
...
GPUCrossfilter is inspired by [NVIDIA RAPIDS cuXfilter](https://github.com/rapidsai/cuxfilter) and the
...
GPUCrossfilter is an independently written, [MIT-licensed](https://github.com/visgl/luma.gl/blob/master/LICENSE)
...
The [GPUCrossfilter API reference](/docs/api-reference/experimental/gpu-crossfilter) includes the live
