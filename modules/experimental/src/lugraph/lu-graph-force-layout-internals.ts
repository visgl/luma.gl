...
export function addLuGraphForceLayoutToGraphWithDispatchLimit<Parameters>(
...
function addInitializationPass<Parameters>(
  ...
  const dispatchLayout = getLuGraphForceLayoutDispatchLayout(
    state.vertexCount,
...
export function getLuGraphForceLayoutDispatchLayout(
  elementCount: number,
  maxComputeWorkgroupsPerDimension: number
