...
import type {LuGraphForceLayout} from './lu-graph-force-layout';
import {addLuGraphSpatialForceLayoutToGraphWithDispatchLimit} from './lu-graph-spatial-force-layout-internals';
...
export type LuGraphSpatialForceLayoutProps = {
 ...
 */
export class LuGraphSpatialForceLayout {
  /** Prefix for generated command-graph nodes and graph-owned synchronization state. */
  readonly id: string;
  ...
  constructor(props: LuGraphSpatialForceLayoutProps) {
    this.id = props.id ?? 'lu-graph-spatial-force-layout';
...
function validateDistinctSpatialOutputs(spatial: LuGraphSpatialForceLayout): void {
