...
import {addGPUGridIndexToGraphWithDispatchLimit} from '../gpu-primitives/gpu-grid-index-internals';
import {
  createTransientView,
  getViewBinding,
  getViewElementOffset
} from '../gpu-primitives/graph-data-view-utils';
import type {LuGraphSpatialForceLayout} from './lu-graph-spatial-force-layout';
...
export function addLuGraphSpatialForceLayoutToGraphWithDispatchLimit<Parameters>(
...
function getSpatialDispatchLayout(
  ...
  return getLuGraphSpatialForceLayoutDispatchLayout(
    elementCount,
    state.maxComputeWorkgroupsPerDimension
  );
}
...
export function getLuGraphSpatialForceLayoutDispatchLayout(
  elementCount: number,
  maxComputeWorkgroupsPerDimension: number
): GPUBoundedDispatchLayout {
