...
import {addLuGraphForceLayoutToGraphWithDispatchLimit} from './lu-graph-force-layout-internals';
...
export type LuGraphForceLayoutProps = {
 ...
 * velocities.
 */
export class LuGraphForceLayout {
  /** Prefix for generated command-graph nodes and imported resources. */
  readonly id: string;
  ...
  constructor(props: LuGraphForceLayoutProps) {
    this.id = props.id ?? 'lu-graph-force-layout';
...
function validateDistinctLayoutVectors(layout: LuGraphForceLayout): void {
