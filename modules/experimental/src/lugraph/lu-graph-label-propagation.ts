...
import {addLuGraphLabelPropagationToGraphWithDispatchLimit} from './lu-graph-label-propagation-internals';
...
export type LuGraphLabelPropagationProps = {
 ...
 */
export class LuGraphLabelPropagation {
  /** Prefix for generated command-graph node and imported-resource identifiers. */
  readonly id: string;
  ...
  constructor(props: LuGraphLabelPropagationProps) {
    this.id = props.id ?? 'lu-graph-label-propagation';
...
function validateDistinctLabelOutputs(propagation: LuGraphLabelPropagation): void {
