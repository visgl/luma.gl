...
import {GPUGraph, GPUGraphTopology, type GPUGraphAdjacency} from '@luma.gl/experimental/gpu-graph';
...
function executeTopology(fixture: ExecutionFixture): void {
  const commandEncoder = fixture.device.createCommandEncoder({id: 'gpu-graph-topology-test'});
...
async function readAdjacency(adjacency: GPUGraphAdjacency): Promise<ReadAdjacency> {
