...
} from '../../src/gpu-graph/gpu-graph-page-rank-internals';
...
function createExecutionFixture(
  ...
  const pageRank = new GPUGraphPageRank({
    topology,
    output,
...
function executePageRank(fixture: PageRankExecutionFixture): void {
  const commandEncoder = fixture.device.createCommandEncoder({id: 'gpu-graph-page-rank-test'});
