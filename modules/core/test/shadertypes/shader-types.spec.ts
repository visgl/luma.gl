...
type AttributeShaderTypeTests = {
  ...
  shaderType: AssertEqual<AttributeShaderTypeT<AttributeShaderType>, AttributeShaderType>;
...
type VariableShaderTypeTests = {
  shaderType: AssertEqual<VariableShaderTypeT<VariableShaderType>, VariableShaderType>;
