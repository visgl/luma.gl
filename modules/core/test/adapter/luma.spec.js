...
test('luma#enforceWebGL2', async (t) => {
    ...
    t.equal(prototype.getContext('experimental-webgl'), 'experimental-webgl-mock', 'mocked getContext experimental-webgl ok');
    ...
    t.equal(prototype.getContext('experimental-webgl'), 'experimental-webgl-mock', 'mocked getContext revert experimental-webgl ok');
    t.equal(prototype.getContext('webgl2'), 'webgl2-mock', 'mocked getContext webgl2 ok');
    t.end();
});
