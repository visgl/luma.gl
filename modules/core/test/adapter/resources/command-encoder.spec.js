...
const COPY_TEXTURE_TO_BUFFER_FIXTURES = [
    {
        title: 'rgba8',
        format: 'rgba8unorm',
...
async function testCopyTextureToBuffer(t, device_, options) {
...
async function readAsyncU8(source) {
    return source.readAsync();
}
async function readAsyncF32(source) {
...
function testCopyToTexture(t, device_, options) {
