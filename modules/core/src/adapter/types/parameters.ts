...
type _RenderParameters = {
  ...
  /** Which vertex in primitive to use for flat shading (perf may improve). Requires 'provoking-vertex-ext' */
  provokingVertex?: 'first' | 'last';
  /** Debug: Set polygon rasterization mode to 'line' for wire frames. Requires: 'polygon-mode-ext' */
  polygonMode?: 'fill' | 'line';
  /** Debug: Enable polygon offset (`depthBias`) for 'line' primitives: Requires 'polygon-mode-ext' */
  polygonOffsetLine?: boolean;

  /** Enables gl_ClipDistance[0] and gl_CullDistance[0]. Requires 'shader-clip-cull-distance-ext' */
  clipDistance0?: boolean;
  /** Enables gl_ClipDistance[1] and gl_CullDistance[1]. Requires 'shader-clip-cull-distance-ext' */
  clipDistance1?: boolean;
  /** Enables gl_ClipDistance[2] and gl_CullDistance[2]. Requires 'shader-clip-cull-distance-ext' */
  clipDistance2?: boolean;
  /** Enables gl_ClipDistance[3] and gl_CullDistance[3]. Requires 'shader-clip-cull-distance-ext' */
  clipDistance3?: boolean;
  /** Enables gl_ClipDistance[4] and gl_CullDistance[4]. Requires 'shader-clip-cull-distance-ext' */
  clipDistance4?: boolean;
  /** Enables gl_ClipDistance[5] and gl_CullDistance[5]. Requires 'shader-clip-cull-distance-ext' */
  clipDistance5?: boolean;
  /** Enables gl_ClipDistance[6] and gl_CullDistance[6]. Requires 'shader-clip-cull-distance-ext' */
  clipDistance6?: boolean;
  /** Enables gl_ClipDistance[7] and gl_CullDistance[7]. Requires 'shader-clip-cull-distance-ext' */
