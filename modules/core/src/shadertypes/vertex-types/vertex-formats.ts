...
export type VertexFormat =
  ...
  | 'uint8' // Chrome 133+
  | 'uint8x2'
  | 'uint8x3' // Legacy alias for uint8x3-webgl
  | 'uint8x3-webgl' // Not in WebGPU
  | 'uint8x4'
  | 'sint8' // Chrome 133+
  | 'sint8x2'
  | 'sint8x3' // Legacy alias for sint8x3-webgl
  | 'sint8x3-webgl' // Not in WebGPU
  | 'sint8x4'
  | 'unorm8' // Chrome 133+
  | 'unorm8x2'
  | 'unorm8x3' // Legacy alias for unorm8x3-webgl
  ...
  | 'snorm8' // Chrome 133+
  | 'snorm8x2'
  | 'snorm8x3' // Legacy alias for snorm8x3-webgl
  | 'snorm8x3-webgl'
  | 'snorm8x4'
  ...
  | 'snorm16' // Chrome 133+
  | 'uint16x2'
  | 'uint16x3' // Legacy alias for uint16x3-webgl
  | 'uint16x3-webgl' // Not in WebGPU
  | 'uint16x4'
  | 'sint16x2'
  | 'sint16x3' // Legacy alias for sint16x3-webgl
  | 'sint16x3-webgl' // Not in WebGPU
  | 'sint16x4'
  | 'unorm16x2'
  | 'unorm16x3' // Legacy alias for unorm16x3-webgl
  | 'unorm16x3-webgl' // Not in WebGPU
  | 'unorm16x4'
  | 'snorm16x2'
  | 'snorm16x3' // Legacy alias for snorm16x3-webgl
