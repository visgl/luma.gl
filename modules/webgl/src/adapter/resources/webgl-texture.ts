...
export class WEBGLTexture extends Texture {
   ...
   * @note The application can call Texture.getMemoryLayout() to compute the layout.
   */
  writeBuffer(buffer: GPUBuffer, options_: WriteTextureOptions = {}) {}
   ...
   * @note The application can call Texture.getMemoryLayout() to compute the layout.
   */
  writeData(data: ArrayBuffer | ArrayBufferView, options_: WriteTextureOptions = {}): void {
    const options = this._normalizeWriteTextureOptions(options_);
  ...
  override readDataSyncWebGL(options_: ReadTextureOptions = {}): ArrayBuffer {
