...
export default class WEBGLTexture extends Texture {
  ...
  /** We can accept a sampler instance or a set of props */
  setSampler(sampler: Sampler | SamplerProps): this {
    this.sampler = sampler instanceof WEBGLSampler ? sampler : new WEBGLSampler(this.device, sampler);
    return this;
  }
...
function getWebGLTextureTarget(props: TextureProps) {
  switch (props.dimension) {
    // supported in WebGL
    case '2d': return GL.TEXTURE_2D;
    case 'cube': return GL.TEXTURE_CUBE_MAP;
    // supported in WebGL2
    case '2d-array': return GL.TEXTURE_2D_ARRAY;
