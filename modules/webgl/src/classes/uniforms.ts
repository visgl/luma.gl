...
type BooleanUniformInfo = {
  type: 'boolean'
  value: boolean
}

type ArrayUniformInfo = {
  type: 'array'
  value: Array<any>
}

type ObjectUniformInfo = {
  type: 'object'
  value: Object
}

type UniformInfo = NumberUniformInfo |
  BooleanUniformInfo |
  ArrayUniformInfo |
  ObjectUniformInfo
...
export function getUniformSetter(gl: WebGLRenderingContext, location: number, info: UniformInfo): any {
