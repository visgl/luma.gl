...
const getGLParameter = (device, parameter) => {
...
test('setDeviceParameters#blending', async (t) => {
    ...
    t.equal(getGLParameter(device, GL.BLEND_EQUATION_RGB), GL.FUNC_ADD, 'GL.BLEND_EQUATION_RGB = GL.FUNC_ADD');
    t.equal(getGLParameter(device, GL.BLEND_EQUATION_ALPHA), GL.FUNC_SUBTRACT, 'GL.BLEND_EQUATION_ALPHA = GL.FUNC_SUBTRACT');
    ...
    t.equal(getGLParameter(device, GL.BLEND_EQUATION_ALPHA), GL.MIN, 'GL.BLEND_EQUATION_ALPHA = GL.MIN');
    t.equal(getGLParameter(device, GL.BLEND_SRC_RGB), GL.SRC_ALPHA, 'GL.BLEND_SRC_RGB = GL.SRC_ALPHA');
    t.equal(getGLParameter(device, GL.BLEND_DST_RGB), GL.DST_ALPHA, 'GL.BLEND_DST_RGB = GL.DST_ALPHA');
