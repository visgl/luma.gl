...
test('getPrimitiveDrawMode', t => {
    ...
    t.throws(() => getPrimitiveDrawMode(-1), 'invalid');
    t.end();
});
test('getPrimitiveCount', t => {
    ...
    t.throws(() => getPrimitiveCount({ drawMode: -1, vertexCount: 12 }), 'invalid');
    t.end();
});
test('getVertexCount', t => {
    ...
    t.throws(() => getVertexCount({ drawMode: -1, vertexCount: 12 }), 'invalid');
    t.end();
});
test('getGLDrawMode', t => {
    ...
    t.throws(() => getGLDrawMode('quad-list'), 'invalid');
    t.end();
});
test('getGLPrimitive', t => {
    ...
    t.throws(() => getGLPrimitive('quad-list'), 'invalid');
    t.end();
});
