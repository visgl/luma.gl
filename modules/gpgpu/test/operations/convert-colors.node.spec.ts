    ...
    const TEST_CASES: ConvertColorsTestCase[] = [
      ...
      },
      {
        ...
        source: device =>
          makeGPUDataSource(
            device,
            new Uint16Array([0xbc00, 0x0000, 0x3800, 0x3c00, 0x3400, 0x3a00, 0x3e00, 0x2e66]),
            'float16x4'
          ),
...
function makeGPUDataSource(device: Device, values: TypedArray, format: VertexFormat): ColorSource {
