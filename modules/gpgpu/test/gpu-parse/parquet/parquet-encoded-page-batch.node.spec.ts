...
it('loaders.gl alpha.7 V1 and V2 pages produce mixed GPU batch plans', async () => {
  expect(ParquetJSWriter.version, 'uses the requested loaders.gl release').toBe('5.0.0-alpha.7');
