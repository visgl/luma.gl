...
export class GPUDotProductScalar {
  ...
  constructor(
    ...
    validatePackedView(props.left, ['float32'], `${this.id} left`);
    validatePackedView(props.right, ['float32'], `${this.id} right`);
    ...
    return [
      createGPUComputeCommandNode<Parameters>({
        ...
        resources: [
          ...
          {buffer: arenaBuffer, usage: 'storage-write'},
        ...
        compile: ({device}) => {
          ...
          return {
            encode: ({computePass, getBuffer}) => {
              ...
              else computation.dispatch(computePass, 1, 1, 1);
            },
