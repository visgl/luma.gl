...
import {addGPUCommandNodes, createGPUComputeCommandNode, type GPUComputeCommandNode} from './gpu-command-node';
...
export class GPUScalarLiteral {
  ...
  getCommandNodes<Parameters>(graph: GPUCommandGraph<Parameters>): readonly GPUComputeCommandNode<Parameters>[] {
