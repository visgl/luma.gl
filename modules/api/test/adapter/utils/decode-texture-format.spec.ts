...
const TEST_CASES: {format: TextureFormat, result: any}[] = [
  ...
  // 16-bit formats
  {format: 'r16uint', result: { format: 'r', components: 0, dataType: 'uint16', byteLength: 2, integer: true, signed: false, normalized: false, srgb: false, webgl: false, unsized: false }},
  {format: 'r16sint', result: { format: 'r', components: 0, dataType: 'sint16', byteLength: 2, integer: true, signed: true, normalized: false, srgb: false, webgl: false, unsized: false }},
  {format: 'r16float', result: { format: 'r', components: 0, dataType: 'float16', byteLength: 2, integer: false, signed: false, normalized: false, srgb: false, webgl: false, unsized: false  }}
];
