...
const TEST_CASES: {format: VertexFormat, result: any}[] = [
  ...
  {format: 'unorm8x2', result: {type: 'unorm8', components: 2, byteLength: 2, integer: true, signed: false, normalized: true}},
  {format: 'snorm8x2', result: {type: 'snorm8', components: 2, byteLength: 2, integer: true, signed: true, normalized: true}},
  ...
  {format: 'unorm16x2', result: {type: 'unorm16', components: 2, byteLength: 4, integer: true, signed: false, normalized: true}},
  {format: 'snorm16x2', result: {type: 'snorm16', components: 2, byteLength: 4, integer: true, signed: true, normalized: true}},
