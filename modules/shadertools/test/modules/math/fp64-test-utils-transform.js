...
function setupFloatTest(device, { glslFunc, binary = false, limit = 256, op, testCases }) {
...
export async function runTests(device, { glslFunc, binary = false, op, limit = 256, testCases, t }) {
    ...
    for (let idx = 0; idx < testCases.length; idx++) {
        ...
        if (!isEqual) {
            ...
            t.comment(` (reference ${reference64}, result64 ${result64})`);
        }
    }
}
