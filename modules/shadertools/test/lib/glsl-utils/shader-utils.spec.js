...
test('shader-utils#convertToVec4', t => {
    t.equal(convertToVec4('one', 1), 'vec4(one, 0.0, 0.0, 1.0)', 'convertToVec4 should return right value for float');
    t.equal(convertToVec4('one', 2), 'vec4(one, 0.0, 1.0)', 'convertToVec4 should return right value for vec2');
    t.equal(convertToVec4('one', 3), 'vec4(one, 1.0)', 'convertToVec4 should return right value for vec3');
