...
test('WebGL#getShaderInfo()', t => {
    t.equal(getShaderInfo(SHADER_1).name, 'name-of-shader', 'getShaderInfo().name extracted correct name');
    t.equal(getShaderInfo(SHADER_2).name, 'unnamed', 'getShaderInfo().name extracted default name');
    t.equal(getShaderInfo(SHADER_3).name, 'name-of-shader', 'getShaderInfo().name extracted correct name');
    t.equal(getShaderInfo(SHADER_4).name, 'name-of-shader', 'getShaderInfo().name extracted correct name');
