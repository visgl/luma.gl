...
type WebGPUTextureProps = TextureProps & {
  handle?: GPUTexture;
  imageUrl?: string;
}

const DEFAULT_TEXTURE_PROPS: Required<WebGPUTextureProps> = {
  handle: undefined,
  id: undefined,
  depth: 1,
  format: 'rgba8unorm',
...
export default class WebGPUTexture extends Resource<WebGPUTextureProps> implements Texture {
  ...
  constructor(device: WebGPUDevice, props: WebGPUTextureProps) {
    super(props, DEFAULT_TEXTURE_PROPS);
