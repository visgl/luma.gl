...
test('Animation#KeyFrames', t => {
    ...
    t.equals(keyFrames.getStartData().val2, 0, 'start data set properly after time set in first frame');
    ...
    t.equals(keyFrames.getStartTime(), 800, 'start time set properly after time set to interior frame');
    t.equals(keyFrames.getEndTime(), 1200, 'end time set properly after time set to interior frame');
    t.equals(keyFrames.getStartData().val2, 1, 'start data set properly after time set to interior frame');
    t.equals(keyFrames.getEndData().val2, 4, 'end data set properly after time set to interior frame');
