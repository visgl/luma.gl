...
const TEST_CASES = [
  {a: obj, b: obj, output: true},
  {a: {x: obj}, b: {x: obj}, depth: 0, output: false},
  {a: {x: obj}, b: {x: obj}, depth: 1, output: true},
  {a: {x: obj}, b: {x: {...obj}}, depth: 1, output: false},
  {a: {x: obj}, b: {x: {...obj}}, depth: 2, output: true},
  {a: {map: {longitude: -122.45, latitude: 37.78, zoom: 8}}, b: {map: {}}, depth: 2, output: false},
  {
  ...
  {a: {x: {y: {z: 1}}}, b: {x: {y: {z: 1}}}, depth: 2, output: false},
  {a: {x: {y: {z: 1}}}, b: {x: {y: {z: 1}}}, depth: 3, output: true},
  {a: {x: {y: {z: 1}}}, b: {x: {y: {z: 2}}}, depth: 2, output: false},
  {a: [1, 2, 3, 4], b: [1, 2, 3, 4], depth: 1, output: true},
  {a: [1, 2, 3, 4], b: [1, 2, 3, 5], depth: 1, output: false},
  {a: [1, 2, 3, 4], b: [1, 2, 3], depth: 1, output: false},
  {a: [1, 2, 3], b: [1, 2, 3, 4], depth: 1, output: false},
  {
    a: [
  ...
  {a: null, b: {x: 1}, depth: 1, output: false},
