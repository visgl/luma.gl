...
const materialProperties = {
  ...
  diffuseTransmission: unitNumberSchema.optional(),
  diffuseTransmissionColor: ANARIVector3Schema.optional(),
  ...
  multiscatterColor: ANARIVector3Schema.optional(),
  scatterAnisotropy: numberSchema.min(-1).max(1).optional(),
  ...
  bumpFactor: nonnegativeNumberSchema.optional(),
  ...
  bumpTexture: identifierSchema.optional(),
  ...
  diffuseTransmissionTexture: identifierSchema.optional(),
  diffuseTransmissionColorTexture: identifierSchema.optional(),
  thicknessTexture: identifierSchema.optional(),
  multiscatterColorTexture: identifierSchema.optional(),
