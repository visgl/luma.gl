...
3. P.3a establishes the optional frontend and bounded fallback; P.3b.1 normalizes explicit coordinate
   frames and eliminates redundant conversions. Land P.3b.2 and P.4 together or in adjacent changes: math.gl supplies the CRS-facing frontend,
