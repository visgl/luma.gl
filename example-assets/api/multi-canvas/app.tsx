...
import {makeMultiCanvasLayout} from './app-ui';
...
export default class App extends React.PureComponent<AppProps, AppState> {
  ...
  override render(): React.ReactNode {
    ...
    return makeMultiCanvasLayout({
      animatedNoiseDescription: ANIMATED_NOISE_DESCRIPTION,
      animatedNoiseTitle: ANIMATED_NOISE_TITLE,
      canvasHeight: CANVAS_HEIGHT,
      canvasRefs: this.canvasRefs,
      canvasWidth: CANVAS_WIDTH,
      concentricWavesDescription: CONCENTRIC_WAVES_DESCRIPTION,
      concentricWavesTitle: CONCENTRIC_WAVES_TITLE,
      initializationError,
      isReady
    });
  }
...
const {
  CONCENTRIC_WAVES_FRAGMENT_WGSL,
  CONCENTRIC_WAVES_FRAGMENT_GLSL,
  ANIMATED_NOISE_FRAGMENT_WGSL,
  ANIMATED_NOISE_FRAGMENT_GLSL,
  FULLSCREEN_SOURCE,
