...
import {makeGPT2InfoHtml} from './app-ui';
...
export default class GPT2TransformerExample extends AnimationLoopTemplate {
  ...
  static info = makeGPT2InfoHtml({
    defaultPrompt: DEFAULT_PROMPT,
    defaultTemperature: DEFAULT_TEMPERATURE,
    minimumTemperature: MINIMUM_TEMPERATURE,
    maximumTemperature: MAXIMUM_TEMPERATURE,
    visualizationColumnCount: VISUALIZATION_COLUMN_COUNT,
    visualizationRowCount: VISUALIZATION_ROW_COUNT
  });
