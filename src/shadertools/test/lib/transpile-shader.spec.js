...
import {createGLContext, transpileShader, picking, fp64} from 'luma.gl';
...
test('transpileShader#version_directive', t => {
  const assembleResult = transpileShader(fixture.gl, {
    vs: VS_GLSL_300,
    fs: FS_GLSL_300,
    modules: [picking]
  });
...
test('transpileShader#getUniforms', t => {
  ...
  assembleResult = transpileShader(fixture.gl, {
    vs: VS_GLSL_300,
    fs: FS_GLSL_300
  });
