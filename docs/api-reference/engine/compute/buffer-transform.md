...
`BufferTransform` is the engine wrapper for WebGL transform-feedback workflows. It internally builds a [`Model`](https://luma.gl/docs/api-reference/engine/model.md) plus a `TransformFeedback` object and uses them to run buffer-to-buffer transforms.
