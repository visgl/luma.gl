...
`GroupNode` extends [`ScenegraphNode`](https://luma.gl/docs/api-reference/engine/scenegraph/scenegraph-node.md) with child-node management and traversal helpers.
