...
`BackgroundTextureModel` is a specialized [`ClipSpace`](https://luma.gl/docs/api-reference/engine/clip-space.md) that renders one texture across the screen while preserving aspect ratio.
