...
An [`AnimationTrack`](https://luma.gl/docs/api-reference/engine/animation/animation-mixer.md) can bind an array of morph weights and call `updateMorphTargetBuffers` from its binding. Asset adapters and higher-level scene renderers already integrate these shared helpers with their own scene objects.
...
* [Animation and deformation guide](https://luma.gl/docs/api-guide/engine/animation.md)
* [AnimationMixer, clips, tracks, and actions](https://luma.gl/docs/api-reference/engine/animation/animation-mixer.md)
* [Geometry](https://luma.gl/docs/api-reference/engine/geometry.md)
* [GPUGeometry](https://luma.gl/docs/api-reference/engine/geometry/gpu-geometry.md)
