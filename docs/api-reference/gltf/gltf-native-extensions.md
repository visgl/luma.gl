...
See [glTF animation and deformation](https://luma.gl/docs/api-reference/gltf/gltf-animation.md) for clip selection, crossfading, automatic skin palettes, and morph-target playback.
...
For the complete extension-by-extension capability matrix, see [glTF extension support](https://luma.gl/docs/api-reference/gltf/gltf-extensions.md).
