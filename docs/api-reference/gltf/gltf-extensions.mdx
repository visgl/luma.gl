...
<table style={{width: '100%'}}>
  ...
  <tbody>
    ...
    <SupportRow name="MSFT_lod" support="❌">
      Authored node levels and <code>MSFT_screencoverage</code> hints remain
      available in the source asset. Scenegraphs and animated crowds render the
      reachable highest-detail level; automatic screen-space selection and LOD
      switching are not implemented. The Asset Studio includes an animated,
      skinned three-level reference fixture.
    </SupportRow>
  </tbody>
</table>
