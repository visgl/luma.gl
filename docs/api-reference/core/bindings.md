...
In luma.gl, bindings are passed by **name** and matched against a [`ShaderLayout`](https://luma.gl/docs/api-reference/core/shader-layout.md).
...
The `group` field is declared on each binding in the [`ShaderLayout`](https://luma.gl/docs/api-reference/core/shader-layout.md).
...
* [`RenderPass`](https://luma.gl/docs/api-reference/core/resources/render-pass.md)
