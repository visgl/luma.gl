...
`ShaderFactory` caches and reuses [`Shader`](https://luma.gl/docs/api-reference/core/resources/shader.md) resources for a device.

This is useful when multiple pipelines or models compile the same shader source repeatedly. Reusing a cached `Shader` reduces compilation overhead and complements [`PipelineFactory`](https://luma.gl/docs/api-reference/core/pipeline-factory.md).
...
* These are device props documented on [`Device`](https://luma.gl/docs/api-reference/core/device.md).
