...
| `maxBindGroupsPlusVertexBuffers`            | <L f="maxBindGroupsPlusVertexBuffers" />            | WebGPU only                           |
| `maxBindingsPerBindGroup`                   | <L f="maxBindingsPerBindGroup" />                   | WebGPU only                           |
...
| `maxBufferSize`                              | <L f="maxBufferSize" />                              | WebGPU reports the native buffer cap; WebGL uses the portable sentinel |
...
| `maxColorAttachments`                       | <L f="maxColorAttachments" />                       | `GL.MAX_COLOR_ATTACHMENTS`            |
| `maxColorAttachmentBytesPerSample`          | <L f="maxColorAttachmentBytesPerSample" />          | WebGPU only                           |
