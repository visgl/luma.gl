...
The [`luma`](https://luma.gl/docs/api-reference/core/luma.md) namespace provides luma.gl applications with the ability to create `Device` class instances against GPU `Adapters` that bring support for different GPU backends such as WebGPU and WebGL.

The returned [`Device`](https://luma.gl/docs/api-reference/core/device.md) instances provide luma.gl applications with a complete GPU API.
...
Properties for creating a new device. See [`DeviceProps`](https://luma.gl/docs/api-reference/core/device.md#deviceprops) for device specific options.
...
Properties for attaching an existing WebGL context or WebGPU device to a new luma Device. See [`DeviceProps`](https://luma.gl/docs/api-reference/core/device.md#deviceprops) for device specific options.
...
* `...deviceProps`: See [`DeviceProps`](https://luma.gl/docs/api-reference/core/device.md#deviceprops) for device specific options.
