...
However, parameters are set on the `RenderPipeline` and are immutable. (luma.gl provides a [`PipelineFactory`](https://luma.gl/docs/api-reference/core/pipeline-factory.md) to help applications work around this limitation.)
...
* luma.gl provides a [`PipelineFactory`](https://luma.gl/docs/api-reference/core/pipeline-factory.md) to help applications work around this limitation.
