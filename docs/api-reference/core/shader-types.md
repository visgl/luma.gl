...
* `uniformTypes` on [`ShaderModule`](https://luma.gl/docs/api-reference/shadertools/shader-module.md)
* `UniformTypes<T>` validation in `@luma.gl/shadertools`
* nested values flowing through [`ShaderInputs`](https://luma.gl/docs/api-reference/engine/shader-inputs.md), [`UniformStore`](https://luma.gl/docs/api-reference/core/uniform-store.md), and [`ShaderBlockLayout`](https://luma.gl/docs/api-reference/core/shader-block-layout.md)

For adjacent type families, see:

* [Vertex Formats](https://luma.gl/docs/api-reference/core/vertex-formats.md)
* [Texture Formats](https://luma.gl/docs/api-reference/core/texture-formats.md)
* [Shader Layout](https://luma.gl/docs/api-reference/core/shader-layout.md)
...
## Composite Type Example[​](#composite-type-example "Direct link to Composite Type Example")
...
## TypeScript Type Inference[​](#typescript-type-inference "Direct link to TypeScript Type Inference")
...
* [`ShaderInputs.setProps()`](https://luma.gl/docs/api-reference/engine/shader-inputs.md) is typed from the module's `PropsT`, so nested struct and array props are checked at the app boundary
...
## From Module Props to Packed Uniform Buffers[​](#from-module-props-to-packed-uniform-buffers "Direct link to From Module Props to Packed Uniform Buffers")
...
## `ShaderInputs` and Composite Uniforms[​](#shaderinputs-and-composite-uniforms "Direct link to shaderinputs-and-composite-uniforms")

[`ShaderInputs`](https://luma.gl/docs/api-reference/engine/shader-inputs.md) uses the declared `uniformTypes` schema when deciding whether a returned value is a uniform or a binding.
...
This is what makes modules like [`lighting`](https://luma.gl/docs/api-reference/shadertools/shader-modules/lighting.md) work with a nested `lights` array at the public API boundary.
