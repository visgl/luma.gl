...
| `timestamp-query`                          | <F f="timestamp-query"/>                          | GPU timer query support                      | `EXT_disjoint_timer_query_webgl2`                                              |
| **WebGL Extensions**                       |
| `compilation-status-async-ext`           | <F f="compilation-status-async-ext"/>           | Non-blocking compile/link status             | `KHR_parallel_shader_compile`                                                  |
| `polygon-mode-ext`                       | <F f="polygon-mode-ext"/>                       | Wireframe rendering parameters (debug only)  | `WEBGL_polygon_mode`                                                           |
| `provoking-vertex-ext`                   | <F f="provoking-vertex-ext"/>                   | Primitive vertex used for flat shading       | `WEBGL_provoking_vertex`                                                       |
| **Shader Extensions**                      |
| `shader-f16`                               | <F f="shader-f16"/>                               | WGSL supports `f16`                          | N/A                                                                            |
| `shader-noperspective-interpolation-ext` | <F f="shader-noperspective-interpolation-ext"/> | GLSL `noperspective` interpolation qualifier | `NV_shader_noperspective_interpolation`                                        |
| `shader-conservative-depth-ext`          | <F f="shader-conservative-depth-ext"/>          | GLSL enable early depth test optimizations   | `EXT_conservative_depth`                                                       |
| `shader-clip-cull-distance-ext`          | <F f="shader-clip-cull-distance-ext"/>          | GLSL `gl_ClipDistance[]/gl_CullDistance[]`   | `WEBGL_clip_cull_distance`                                                     |
| **Texture Extensions**                     |
...
| `float32-renderable-ext`                 | <F f="float32-renderable-ext"/>                 | float32 textures renderable                  | `EXT_color_buffer_float`                                                       |
| `float16-renderable-ext`                 | <F f="float16-renderable-ext"/>                 | float16 textures renderable                  | `EXT_color_buffer_half_float`                                                  |
| `rgb9e5ufloat-renderable-ext`            | <F f="rgb9e5ufloat-renderable-ext"/>            | `rgb9e5ufloat` renderable                    | ['WEBGL_render_shared_exponent'][WEBGL_render_shared_exponent]                 |
| `snorm8-renderable-ext`                  | <F f="snorm8-renderable-ext"/>                  | `r,rg,rgba8snorm` renderable                 | [EXT_render_snorm][EXT_render_snorm]                                           |
| `norm16-renderable-ext`                  | <F f="norm16-renderable-ext"/>                  | `r,rg,rgba16norm` renderable                 | [EXT_texture_norm16][EXT_texture_norm16]                                       |
| `snorm16-renderable-ext`                 | <F f="snorm16-renderable-ext"/>                 | `r,rg,rgba16snorm` renderable                | [EXT_texture_norm16][EXT_texture_norm16], [EXT_render_snorm][EXT_render_snorm] |
| `float32-filterable`                       | <F f="float32-filterable"/>                       | float32 textures are filterable              | `OES_texture_float_linear`                                                     |
| `float16-filterable-ext`                 | <F f="float16-filterable-ext"/>                 | float16 textures are filterable              | `OES_texture_half_float_linear`                                                |
| `texture-filterable-anisotropic-ext`     | <F f="texture-filterable-anisotropic-ext"/>     | anisotropic filtering, common                | `EXT_texture_filter_anisotropic`                                               |
| `bgra8unorm-storage`                       | <F f="bgra8unorm-storage"/>                       | can be used as storage binding.              |
| `texture-blend-float-ext`                | <F f="texture-blend-float-ext"/>                | float texture blending                       | `EXT_float_blend`                                                              |
| **Compressed Texture Support**             |
| `texture-compression-bc`                   | <F f="texture-compression-bc"/>                   | DXT (BC1-BC7). Desktops.                     |
| `texture-compression-bc5-ext`            | <F f="texture-compression-bc5-ext"/>            | DXT (BC1-BC5). Desktops.                     |
...
| `texture-compression-etc1-ext`           | <F f="texture-compression-etc1-ext"/>           | Qualcomm Snapdragon. Android.                |
| `texture-compression-pvrtc-ext`          | <F f="texture-compression-pvrtc-ext"/>          | PowerVR GPUs, iOS devices.                   |
| `texture-compression-atc-ext`            | <F f="texture-compression-atc-ext"/>            | Qualcomm Adreno GPUs. Android.               |
