...
<CoreDocsTabs group="shader-types" active="texture-formats" />
...
| `pvrtc-rgb2unorm-webgl`               | <Ft f="pvrtc-rgb2unorm-webgl" />    | <L f="pvrtc-rgb2unorm-webgl" />    | <R f="pvrtc-rgb2unorm-webgl" />    | `GL.COMPRESSED_RGB_PVRTC_2BPPV1_IMG`                                                                                    |
