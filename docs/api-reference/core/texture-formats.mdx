...
| `r16unorm`                            | <Ft f="r16unorm" />                 | <L f="r16unorm" />                 | <R f="r16unorm" />                 | `GL.R16_EXT` `EXT_texture_norm16`                                                                                       |
| `r16snorm`                            | <Ft f="r16snorm" />                 | <L f="r16snorm" />                 | <R f="r16snorm" />                 | `GL.R16_SNORM_EXT` `EXT_texture_norm16`                                                                                 |
...
| `rgba4unorm-ext`                      | <Ft f="rgba4unorm-ext" />           | <L f="rgba4unorm-ext" />           | <R f="rgba4unorm-ext" />           | `GL.RGBA4`                                                                                                              |
| `rgb565unorm-ext`                     | <Ft f="rgb565unorm-ext" />          | <L f="rgb565unorm-ext" />          | <R f="rgb565unorm-ext" />          | `GL.RGB565`                                                                                                             |
| `rgb5a1unorm-ext`                     | <Ft f="rgb5a1unorm-ext" />          | <L f="rgb5a1unorm-ext" />          | <R f="rgb5a1unorm-ext" />          | `GL.RGB5_A1`                                                                                                            |
| **3 bytes per pixel formats**         |                                     |
| `rgb8unorm-ext`                       | <Ft f="rgb8unorm-ext" />            | <L f="rgb8unorm-ext" />            | <R f="rgb8unorm-ext" />            | `GL.RGB8`                                                                                                               |
...
| `rg16snorm`                           | <Ft f="rg16snorm" />                | <L f="rg16snorm" />                | <R f="rg16snorm" />                |                                                                                                                         |
...
| `rgb16unorm-ext`                    | <Ft f="rgb16unorm-ext" />         | <L f="rgb16unorm-ext" />         | <R f="rgb16unorm-ext" />         |                                                                                                                         |
| `rgb16snorm-ext`                    | <Ft f="rgb16snorm-ext" />         | <L f="rgb16snorm-ext" />         | <R f="rgb16snorm-ext" />         |                                                                                                                         |
...
| `rgb32float-ext`                    | <Ft f="rgb32float-ext" />         | <L f="rgb32float-ext" />         | <R f="rgb32float-ext" />         | `GL.RGB32F` Deprecated format.                                                                                          |
...
| `bc1-rgb-unorm-ext`                 | <Ft f="bc1-rgb-unorm-ext" />      | <L f="bc1-rgb-unorm-ext" />      | <R f="bc1-rgb-unorm-ext" />      | BC1 / DXT1: 16 input pixels in 64 bits.                                                                                 |
| `bc1-rgb-unorm-srgb-ext`            | <Ft f="bc1-rgb-unorm-srgb-ext" /> | <L f="bc1-rgb-unorm-srgb-ext" /> | <R f="bc1-rgb-unorm-srgb-ext" /> |                                                                                                                         |
...
| **`texture-compression-pvrtc-ext`** |                                     |                                    |                                    | `WEBGL_compressed_texture_pvrtc`                                                                                        |
| `pvrtc-rgb4unorm-ext`               | <Ft f="pvrtc-rgb4unorm-ext" />    | <L f="pvrtc-rgb4unorm-ext" />    | <R f="pvrtc-rgb4unorm-ext" />    | `GL.COMPRESSED_RGB_PVRTC_4BPPV1_IMG`                                                                                    |
| `pvrtc-rgba4unorm-ext`              | <Ft f="pvrtc-rgba4unorm-ext" />   | <L f="pvrtc-rgba4unorm-ext" />   | <R f="pvrtc-rgba4unorm-ext" />   | `GL.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG`                                                                                   |
| `pvrtc-rgb2unorm-ext`               | <Ft f="pvrtc-rgb2unorm-ext" />    | <L f="pvrtc-rgb2unorm-ext" />    | <R f="pvrtc-rgb2unorm-ext" />    | `GL.COMPRESSED_RGB_PVRTC_2BPPV1_IMG`                                                                                    |
| `pvrtc-rgba2unorm-ext`              | <Ft f="pvrtc-rgba2unorm-ext" />   | <L f="pvrtc-rgba2unorm-ext" />   | <R f="pvrtc-rgba2unorm-ext" />   | `GL.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG`                                                                                   |
| **`texture-compression-etc1-ext`**  |
| `etc1-rbg-unorm-ext`                | <Ft f="etc1-rbg-unorm-ext" />     | <L f="etc1-rbg-unorm-ext" />     | <R f="etc1-rbg-unorm-ext" />     | `GL.COMPRESSED_RGB_ETC1_WEBGL`                                                                                          |
| **`texture-compression-pvrtc-ext`** |
| `atc-rgb-unorm-ext`                 | <Ft f="atc-rgb-unorm-ext" />      | <L f="atc-rgb-unorm-ext" />      | <R f="atc-rgb-unorm-ext" />      | `GL.COMPRESSED_RGB_ATC_WEBGL`                                                                                           |
| `atc-rgba-unorm-ext`                | <Ft f="atc-rgba-unorm-ext" />     | <L f="atc-rgba-unorm-ext" />     | <R f="atc-rgba-unorm-ext" />     | `GL.COMPRESSED_RGBA_ATC_EXPLICIT_ALPHA_WEBGL`                                                                           |
| `atc-rgbai-unorm-ext`               | <Ft f="atc-rgbai-unorm-ext" />    | <L f="atc-rgbai-unorm-ext" />    | <R f="atc-rgbai-unorm-ext" />    | `GL.COMPRESSED_RGBA_ATC_INTERPOLATED_ALPHA_WEBGL`                                                                       |
...
| ------------------------------------- | --------------------------------------------------------- |
| `float32-renderable-ext`              | Floating point textures are color-renderable and readable |
| `float16-renderable-ext`              | Half float textures are color-renderable and readable     |
| `rgb9e5ufloat-renderable-ext`         | `rgb9e5ufloat` is renderable                              |
| `snorm8-renderable-ext`               | `r`, `rg`, and `rgba8snorm` formats are renderable        |
| `norm16-ext`                          | 16-bit normalized texture formats are available           |
| `norm16-renderable-ext`               | `r`, `rg`, and `rgba16unorm` formats are renderable       |
| `snorm16-renderable-ext`              | `r`, `rg`, and `rgba16snorm` formats are renderable       |
| `float32-filterable`                  | `linear` sampling of float32 textures                     |
| `float16-filterable-ext`              | `linear` sampling of float16 textures                     |
| `texture-filterable-anisotropic-ext`  | anisotropic filtering                                     |
...
| --------------------------------- | ----------------------------------------- | -------------------------------- | ---------------------------------------- |
| `texture-compression-bc5-ext`   | DXT compressed textures (BC1-BC5)         | Mainly desktops.                 |                                          |
| `texture-compression-bc`          | DXT compressed textures (BC1-BC7)         | Mainly desktops.                 | Includes `texture-compression-bc5-ext` |
...
| `texture-compression-pvrtc-ext` | PowerVR chipsets.                         | iPhone, iPad, certain Android    |                                          |
| `texture-compression-atc-ext`   | Adreno GPUs                               | Qualcomm Snapdragon devices.     |                                          |
| `texture-compression-etc1-ext`  | Ericsson Compression                      | Older ETC compression.           |                                          |
