...
| `data?` | `ExternalImage \| TypedArray \| null` | `null` | Initial pixel data. This path is deprecated in favor of [`DynamicTexture`](/docs/api-reference/engine/dynamic-texture.md) and only supports direct image uploads. |
