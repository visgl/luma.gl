...
A `ComputePipeline` holds a compiled compute shader plus the [`ComputeShaderLayout`](https://luma.gl/docs/api-reference/core/shader-layout.md) that describes its bindings.
