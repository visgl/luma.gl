...
The use of framebuffers is described in detail in the [Rendering Guide](https://luma.gl/docs/api-guide/gpu/gpu-rendering.md).
...
luma.gl does not yet expose a managed offscreen MSAA resolve path. For the current WebGL and WebGPU landscape, and the proposed color-only framebuffer API, see [Antialiasing and Multisampling](https://luma.gl/docs/api-guide/gpu/gpu-antialiasing.md) and [RFC #2741](https://github.com/visgl/luma.gl/issues/2741).
