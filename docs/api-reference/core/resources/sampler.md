...
For more information, see [Sampling](https://luma.gl/docs/api-guide/gpu/gpu-textures.md#sampling) in the API Guide.
...
For more information, see [GPU Textures](https://luma.gl/docs/api-guide/gpu/gpu-textures.md#mipmaps).
