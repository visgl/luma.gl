...
For guidance on how this data is used for profiling in luma.gl, see [Performance Profiling](https://luma.gl/docs/developer-guide/profiling.md). For guidance on how queries fit into explicit command streams, see [GPU Commands](https://luma.gl/docs/api-guide/gpu/gpu-commands.md).
...
* [RenderPass props](https://luma.gl/docs/api-reference/core/resources/render-pass.md#renderpassprops): pass query sets through `timestampQuerySet`, `beginTimestampIndex`, `endTimestampIndex`, or `occlusionQuerySet`.
* [ComputePass props](https://luma.gl/docs/api-reference/core/resources/compute-pass.md#computepassprops): pass `timestampQuerySet`, `beginTimestampIndex`, and `endTimestampIndex`.
* [Command encoding](https://luma.gl/docs/api-reference/core/resources/command-encoder.md): use `CommandEncoder.writeTimestamp()` for manual timestamp capture.
