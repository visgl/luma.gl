...
| `resourceInstrumentation?: ResourceInstrumentation \| null` | default stats instrumentation                 | Observes resource lifecycle and allocation events. Set to `null` to disable resource stats bookkeeping.     |
