...
| `mipmapGenerator?: MipmapGenerator`                    | `null`                                        | Optional backend capability for generating texture mipmaps. Use `webgpuMipmapGenerator` from `@luma.gl/webgpu/mipmaps` for WebGPU. |
