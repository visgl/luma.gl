...
Create a new `Device`, auto creating a canvas and a new WebGL 2 context. See [`luma.createDevice()`](https://luma.gl/docs/api-reference/core/luma.md#lumacreatedevice).
...
This object can also include all [`CanvasContextProps`](https://luma.gl/docs/api-reference/core/canvas-context.md#canvascontextprops) properties to configure how a new canvas is created. If a canvas is provided, these are ignored.
...
| `createCanvasContext?: CanvasContextProps` \| `true`                    | [CanvasContexProps](https://luma.gl/docs/api-reference/core/canvas-context.md#canvascontextprops)                           | Create a default `CanvasContext` for the new `Device`. `true` creates a context with default props.                                                                                                                                                                                                         |
...
Learn more GPU debugging in our [Debugging](https://luma.gl/docs/developer-guide/debugging.md) guide.
...
| Property                      | Default | Description                                                                                                                                                                                                                                                                   |
| ----------------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `_cacheShaders?: boolean`     | `true`  | Enable shader caching through [`ShaderFactory`](https://luma.gl/docs/api-reference/core/shader-factory.md).                                                                                                                                                                   |
...
| `_cachePipelines?: boolean`   | `true`  | Enable [`PipelineFactory`](https://luma.gl/docs/api-reference/core/pipeline-factory.md) wrapper caching.                                                                                                                                                                      |
| `_sharePipelines?: boolean`   | `true`  | When pipeline caching is enabled, allow compatible WebGL render-pipeline wrappers to share a linked `WebGLProgram`. See [`PipelineFactory`](https://luma.gl/docs/api-reference/core/pipeline-factory.md) for the distinction between wrapper reuse and shared-program reuse.  |
...
| `webgl.antialias?: boolean`              | `true`  | Best-effort request to antialias the WebGL default drawing buffer. See [Antialiasing and Multisampling](https://luma.gl/docs/api-guide/gpu/gpu-antialiasing.md). |
...
WGSL language extensions exposed by the browser. Unlike `device.features`, these extensions are discovered dynamically and are not requested during device creation. Non-WebGPU devices expose an empty set.
...
Returns the default [`CanvasContext`](https://luma.gl/docs/api-reference/core/canvas-context.md).
...
Creates a new [`CanvasContext`](https://luma.gl/docs/api-reference/core/canvas-context.md). WebGL devices can only render into the canvas they were created with.
...
Creates a new [`PresentationContext`](https://luma.gl/docs/api-reference/core/presentation-context.md) for multi-canvas presentation.
...
See [GPU Commands](https://luma.gl/docs/api-guide/gpu/gpu-commands.md) for when `submit()` is required, how it relates to `CommandEncoder.finish()`, and why WebGL and WebGPU differ here.
...
Creates a [`Buffer`](https://luma.gl/docs/api-reference/core/resources/buffer.md) used to manage memory on the GPU. See [`BufferProps`](https://luma.gl/docs/api-reference/core/resources/buffer.md#bufferprops) for available options.
...
Creates a [`Texture`](https://luma.gl/docs/api-reference/core/resources/texture.md), used to manage image data memory on the GPU. See [`TextureProps`](https://luma.gl/docs/api-reference/core/resources/texture.md#textureprops) for available options.
...
Creates a [`Sampler`](https://luma.gl/docs/api-reference/core/resources/sampler.md). See [`SamplerProps`](https://luma.gl/docs/api-reference/core/resources/sampler.md#samplerprops) for available options.
...
Creates a [`Framebuffer`](https://luma.gl/docs/api-reference/core/resources/framebuffer.md). See [`FramebufferProps`](https://luma.gl/docs/api-reference/core/resources/framebuffer.md#framebufferprops) for available options.
...
Creates a [`Shader`](https://luma.gl/docs/api-reference/core/resources/shader.md). See [`ShaderProps`](https://luma.gl/docs/api-reference/core/resources/shader.md#shaderprops) for available options.
...
Creates a [`Fence`](https://luma.gl/docs/api-reference/core/resources/fence.md) used to wait for completion of submitted GPU work. See [`FenceProps`](https://luma.gl/docs/api-reference/core/resources/fence.md#fenceprops) for available options.
...
Creates a [`RenderPass`](https://luma.gl/docs/api-reference/core/resources/render-pass.md). See [`RenderPassProps`](https://luma.gl/docs/api-reference/core/resources/render-pass.md#renderpassprops) for available options.

* `props.framebuffer` If omitted, renders into the default canvas context's default framebuffer.
* See [GPU Commands](https://luma.gl/docs/api-guide/gpu/gpu-commands.md) for the difference between pass recording on WebGPU and best-effort immediate behavior on WebGL.
...
Creates a [`ComputePass`](https://luma.gl/docs/api-reference/core/resources/compute-pass.md) which can be used to bind data and run compute operations using compute pipelines. See [`ComputePassProps`](https://luma.gl/docs/api-reference/core/resources/compute-pass.md#computepassprops) for available options.

See [GPU Commands](https://luma.gl/docs/api-guide/gpu/gpu-commands.md) for how compute work is recorded and submitted.
