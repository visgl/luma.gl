...
The [ANARI JSON scenes guide](https://luma.gl/docs/api-guide/engine/anari-json-scenes.md#validate-scenes-with-zod-and-json-schema) and [JSON scene playground](https://luma.gl/docs/api-guide/engine/anari-json-scenes.md#explore-the-json-scene-playground) show how these schemas integrate with live scene editing. See [ANARI animation and glTF integration](https://luma.gl/docs/api-reference/scene/anari-animation.md) for retained playback and optional glTF adapter details.
