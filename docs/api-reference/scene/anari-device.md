...
See [arrays and geometry](https://luma.gl/docs/api-reference/scene/anari-geometry.md), [materials and lighting](https://luma.gl/docs/api-reference/scene/anari-materials-and-lights.md), [scene hierarchy](https://luma.gl/docs/api-reference/scene/anari-scene.md), and [cameras, renderers, and frames](https://luma.gl/docs/api-reference/scene/anari-rendering.md) for complete parameter details.
