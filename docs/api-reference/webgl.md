...
[Overview](https://luma.gl/docs/api-reference/webgl.md)[Constants](https://luma.gl/docs/api-reference/webgl/constants.md)[WebGPU adapter](https://luma.gl/docs/api-reference/webgpu.md)
...
Importing `webgl2Adapter` from `@luma.gl/webgl` enables WebGL devices to be created using `luma.createDevice(props)`. See [`CreateDeviceProps`](https://luma.gl/docs/api-reference/core/luma.md#createdeviceprops) for WebGL property options.
...
When raw numeric WebGL enums are still needed, import them from [`@luma.gl/webgl/constants`](https://luma.gl/docs/api-reference/webgl/constants.md).
