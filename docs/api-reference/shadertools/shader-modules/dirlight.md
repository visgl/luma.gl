...
The `dirlight` shader module is a lightweight alternative to the full [`lighting`](https://luma.gl/docs/api-reference/shadertools/shader-modules/lighting.md) module. It applies a single directional-light dot product and is intended for simple materials or examples that do not need multiple light sources.
...
* If you need ambient light, multiple lights, or shared scene lighting across several material modules, use [`lighting`](https://luma.gl/docs/api-reference/shadertools/shader-modules/lighting.md) instead.
