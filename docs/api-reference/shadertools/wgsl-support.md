...
`@luma.gl/shadertools` supports WGSL shader assembly in addition to GLSL. For cross-backend authoring guidance, see [Writing Portable Shaders](https://luma.gl/docs/api-guide/shaders/writing-portable-shaders.md).
...
See [`ShaderAssembler`](https://luma.gl/docs/api-reference/shadertools/shader-assembler.md) for the API details.
...
* [`ShaderAssembler`](https://luma.gl/docs/api-reference/shadertools/shader-assembler.md)
