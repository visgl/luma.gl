...
For the current public guidance, see the [Bind Groups and Bindings Guide](https://luma.gl/docs/api-guide/gpu/gpu-bindings.md).

For shader module descriptor fields, see [`ShaderModule`](https://luma.gl/docs/api-reference/shadertools/shader-module.md). For passes that run shader modules through an engine renderer, see [`ShaderPass`](https://luma.gl/docs/api-reference/shadertools/shader-pass.md).
