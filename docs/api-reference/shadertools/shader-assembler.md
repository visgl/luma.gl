...
For the assembly model, see [Shader Assembly](https://luma.gl/docs/api-guide/shaders/shader-assembly.md). For extension design, see [Writing Customizable Shaders](https://luma.gl/docs/api-guide/shaders/writing-customizable-shaders.md). For WGSL binding relocation and conditionals, see [WGSL Support](https://luma.gl/docs/api-reference/shadertools/wgsl-support.md).
