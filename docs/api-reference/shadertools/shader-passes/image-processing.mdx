...
[`CompositeShaderPass`](/docs/api-reference/shadertools/shader-pass#compositeshaderpass) graphs can
...
accepts individual shader-pass modules. Named-target `CompositeShaderPass` graphs and the separate
