...
Applies a stronger separable blur using Gaussian weights. This is a better starting point than `triangleBlur` when you want a softer, more photographic blur kernel.

- `radius` The blur radius in pixels. Default value is `12`.
