...
* [FXAA](https://luma.gl/docs/api-reference/shadertools/shader-passes/fxaa.md) smooths one display image without history or auxiliary attachments.
* [Camera-Reprojection Antialiasing](https://luma.gl/docs/api-reference/shadertools/shader-passes/camera-reprojection-antialiasing.md) derives motion from camera matrices rather than a velocity texture.
* [Motion Blur](https://luma.gl/docs/api-reference/shadertools/shader-passes/motion-blur.md) uses the same depth and velocity attachments for directional shutter blur.
