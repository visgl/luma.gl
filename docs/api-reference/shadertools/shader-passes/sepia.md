...
The effect is one source-color filter with no extra textures or temporal state. Combining it with [Vignette](https://luma.gl/docs/api-reference/shadertools/shader-passes/vignette.md) and a small amount of [Noise](https://luma.gl/docs/api-reference/shadertools/shader-passes/noise.md) produces a photographic finishing stack. Run the sepia transform before those finishing effects when the grain and edge darkening should remain neutral.

## Related Effects[​](#related-effects "Direct link to Related Effects")

* [Hue and Saturation](https://luma.gl/docs/api-reference/shadertools/shader-passes/hue-saturation.md) offers freeform hue rotation and desaturation.
* [Noise](https://luma.gl/docs/api-reference/shadertools/shader-passes/noise.md) adds controllable monochrome grain.
* [Vignette](https://luma.gl/docs/api-reference/shadertools/shader-passes/vignette.md) concentrates attention toward the image center.
