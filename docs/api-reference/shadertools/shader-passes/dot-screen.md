...
* [Color Halftone](https://luma.gl/docs/api-reference/shadertools/shader-passes/color-halftone.md) creates independent full-color print patterns.
* [Brightness and Contrast](https://luma.gl/docs/api-reference/shadertools/shader-passes/brightness-contrast.md) controls the luminance entering the screen.
* [Ink](https://luma.gl/docs/api-reference/shadertools/shader-passes/ink.md) produces a complementary contour-oriented illustrated style.
