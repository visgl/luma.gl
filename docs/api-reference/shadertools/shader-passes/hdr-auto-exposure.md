...
* [Bloom](https://luma.gl/docs/api-reference/shadertools/shader-passes/bloom.md) supports exposure-aware highlight thresholds and exposure-corrected temporal history.
* [Tone Mapping](https://luma.gl/docs/api-reference/shadertools/shader-passes/tone-mapping.md) converts the adapted HDR image into display-ready color.
* [Temporal Antialiasing](https://luma.gl/docs/api-reference/shadertools/shader-passes/temporal-antialiasing.md) normally precedes exposure and bloom in the render stack.
