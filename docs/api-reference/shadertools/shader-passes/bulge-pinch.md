...
* [Magnify](https://luma.gl/docs/api-reference/shadertools/shader-passes/magnify.md) enlarges pixels inside an adjustable circular lens.
* [Swirl](https://luma.gl/docs/api-reference/shadertools/shader-passes/swirl.md) rotates sample positions around a focal center.
* [Zoom Blur](https://luma.gl/docs/api-reference/shadertools/shader-passes/zoom-blur.md) produces radial motion streaks around a selected point.
