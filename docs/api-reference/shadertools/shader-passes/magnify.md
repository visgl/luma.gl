...
* [Bulge and Pinch](https://luma.gl/docs/api-reference/shadertools/shader-passes/bulge-pinch.md) applies smoothly varying circular lens distortion.
* [Swirl](https://luma.gl/docs/api-reference/shadertools/shader-passes/swirl.md) rotates sample coordinates around a circular focal region.
* [Zoom Blur](https://luma.gl/docs/api-reference/shadertools/shader-passes/zoom-blur.md) creates radial streaks instead of a sharply enlarged lens image.
