...
* [Shader Passes guide](https://luma.gl/docs/api-guide/shaders/shader-passes.md)
* [`ShaderPassRenderer`](https://luma.gl/docs/api-reference/engine/passes/shader-pass-renderer.md)
* [Shader Pass Catalog](https://luma.gl/docs/api-reference/shadertools/shader-passes/image-processing.md)
