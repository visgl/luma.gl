...
Each operation returns a new [`GPUDataEvaluator`](https://luma.gl/docs/api-reference/gpgpu/gpu-data-evaluator.md). No GPU work is performed until that output table is evaluated.
