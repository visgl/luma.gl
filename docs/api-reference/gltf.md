...
`GLTFAnimator.setTime()` takes an absolute clock value in **milliseconds**. The shared `AnimationMixer` exposed as `scenegraphs.animator.mixer` uses **seconds**. See [glTF animation and deformation](https://luma.gl/docs/api-reference/gltf/gltf-animation.md) before mixing the legacy wall-clock API with direct mixer controls.
...
See [glTF animation and deformation](https://luma.gl/docs/api-reference/gltf/gltf-animation.md), the [GPU-animated crowd reference](https://luma.gl/docs/api-reference/gltf/gltf-animated-crowd.md), the [engine animation guide](https://luma.gl/docs/api-guide/engine/animation.md), and [glTF extension support](https://luma.gl/docs/api-reference/gltf/gltf-extensions.md) for details and limitations.
...
See [GPU-animated glTF crowds](https://luma.gl/docs/api-reference/gltf/gltf-animated-crowd.md) for the complete render loop, actor lifecycle, batching, backend requirements, current morph and LOD limitations, and Animation Studio controls.
...
See [glTF asset interchange](https://luma.gl/docs/api-reference/gltf/gltf-interchange.md) for typed descriptors, RGBA vertex colors, normalized joint weights, animation pointers, and resource ownership.
