...
* [Device and object lifecycle](https://luma.gl/docs/api-reference/scene/anari-device.md): `ANARIDevice`, object creation, renderer registration, discovery, staged parameters, commits, and destruction.
* [Arrays and geometry](https://luma.gl/docs/api-reference/scene/anari-geometry.md): triangle meshes, RGB/RGBA colors, secondary UVs, joint palettes, morph targets, and analytic primitives.
* [Materials and lighting](https://luma.gl/docs/api-reference/scene/anari-materials-and-lights.md): all 21 canonical PBR maps, alpha masking/blending, UV samplers, punctual lights, and existing image-based lighting.
...
See [HDR and backend selection](https://luma.gl/docs/api-guide/engine/anari-first-scene.md#hdr-and-backend-selection) for capability detection and canvas setup.
