...
| **Reads / writes**       | Reads a GPUGridIndex and query parameters; writes IDs, full candidate count, overflow, and optional mask.     |
...
**Common mistake**Candidates are not exact geometry hits; refine when exactness matters.
