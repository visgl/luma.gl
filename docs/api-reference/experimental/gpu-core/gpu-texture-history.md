...
<GPUCoreDocsTabs active="texture-history" />
...
[`GPUCommandGraph.encode()`](/docs/api-reference/experimental/gpu-core/gpu-command-graph#compiledgpucommandgraph),
...
<GPUOperationContract operation="gpu-texture-history" />
...
aliases](/docs/api-reference/experimental/gpu-core/gpu-command-graph#physical-texture-overlap-and-writable-aliases)
