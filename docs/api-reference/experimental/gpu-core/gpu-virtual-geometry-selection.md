...
<GPUCoreDocsTabs active="virtual-geometry" />
...
<GPUOperationContract operation="gpu-virtual-geometry-selection" />
...
addGPUCommandNodes(graph, new GPUVirtualGeometrySelection({
  hierarchy: {
    sphereBounds,
    geometricErrors,
    children,
