...
**Common mistake**Do not confuse exclusive output positions with inclusive cumulative totals.
...
See [Optional WebGPU and WGSL features](https://luma.gl/docs/api-reference/webgpu/optional-features.md) for why these two capabilities use different discovery and request mechanisms.
