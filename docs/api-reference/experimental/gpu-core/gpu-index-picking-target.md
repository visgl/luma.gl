...
<GPUCoreDocsTabs active="index-picking" />
...
<GPUOperationContract operation="gpu-index-picking-target" />
...
Use [`GPUReadbackRing`](/docs/api-reference/experimental/gpu-core/gpu-readback-ring) to move
