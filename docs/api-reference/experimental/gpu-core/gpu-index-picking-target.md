...
Use [`GPUReadbackRing`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-readback-ring.md) to move the small packed result to the CPU without allocating or remapping the same staging buffer every frame.
