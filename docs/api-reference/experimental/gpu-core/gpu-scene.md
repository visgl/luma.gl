...
<GPUOperationContract operation="gpu-scene" />
...
slot names where a later workflow may write; this class does not allocate or encode indirect
...
[scene adapters](/docs/api-reference/experimental/gpu-core/gpu-scene-adapters) add explicit
