...
- [`GPUSort`](/docs/api-reference/experimental/gpu-primitives/gpu-sort) orders one complete packed
...
can extend this contract in a future tranche without changing independent-domain semantics.
