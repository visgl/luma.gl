...
The [GPU Data Analysis example](https://luma.gl/examples/experimental/gpu-data-analysis) uploads real Apache Arrow tables and compares GPU filtering, dense grouping, stable sorting, and unique-right joins against CPU references. Its GPU Dataframe benchmark is opt-in and separately reports upload, graph compilation, index construction, fenced GPU execution, explicit validation readback, and CPU execution.
...
Import the dataframe facade only from its optional subpath. Generic GPU storage remains in `@luma.gl/gpgpu/gpu-data`, while record batches and tables come from `@luma.gl/experimental/gpu-tables`.
...
## Borrow an existing table[​](#borrow-an-existing-table "Direct link to Borrow an existing table")
...
| Family                                                                                                    | Use it for                                                            |
| --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| [Expressions and filtering](https://luma.gl/docs/api-reference/experimental/gpu-dataframe-expressions.md) | Immutable predicates, nullable derived columns, and retained results. |
| [Grouping and aggregation](https://luma.gl/docs/api-reference/experimental/gpu-dataframe-aggregation.md)  | Dense categorical groups, reductions, and histograms.                 |
| [Sorting and top-K](https://luma.gl/docs/api-reference/experimental/gpu-dataframe-sorting.md)             | Stable per-batch ordering, global ordering, and bounded selection.    |
| [Indexes and joins](https://luma.gl/docs/api-reference/experimental/gpu-dataframe-indexes-joins.md)       | Unique-key lookup and sharing outputs with rendering or filters.      |
...
The opt-in [GPU Data Analysis benchmark](https://luma.gl/examples/experimental/gpu-data-analysis) reports separate durations for:
...
* [GPU data analysis example](https://luma.gl/examples/experimental/gpu-data-analysis)
