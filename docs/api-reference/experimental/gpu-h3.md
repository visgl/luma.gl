...
The operation is the H3-typed adapter over the shared [`GPUDGGSCellProjection`](https://luma.gl/docs/api-reference/experimental/gpu-dggs.md) primitive. It adds no family-specific JavaScript overhead.
