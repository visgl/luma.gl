...
For a guided explanation of missing observations, grid ownership, replay, resource lifetimes, and common mistakes, read [GPURaster Concepts and Execution Model](https://luma.gl/docs/api-reference/experimental/gpu-raster/concepts.md).
...
The `./gpu-raster` subpath is an explicit opt-in. Its runtime symbols are not exported from `@luma.gl/experimental`, and the package remains experimental.
