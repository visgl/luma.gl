---
title: GPURaster analytical overviews
description: Nodata-aware continuous and categorical overview pyramids with preserved spatial metadata.
---
...
`sourcePixelOrigin`, GPURaster infers its `levelZeroOrigin` or `[0, 0]` and rejects globally
