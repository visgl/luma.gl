...
### `deferredLighting`[​](#deferredlighting "Direct link to deferredlighting")
...
### `makeDeferredPointLightBufferData(lights, maxLightCount?): Float32Array`[​](#makedeferredpointlightbufferdatalights-maxlightcount-float32array "Direct link to makedeferredpointlightbufferdatalights-maxlightcount-float32array")
...
* [`GBuffer`](https://luma.gl/docs/api-reference/experimental/g-buffer.md) owns the MRT attachments and standard depth, normal, and velocity bindings.
* [Clustered Lighting](https://luma.gl/docs/api-reference/experimental/clustered-lighting.md) reuses the same material attachments with compute-built light lists for hundreds of local lights.
* [Shader Passes](https://luma.gl/docs/api-guide/shaders/shader-passes.md) explains the ordered composable render stack.
* [Advanced Effects](https://luma.gl/examples/experimental/advanced-effects) shows the broader scene-aware and temporal effect chain after opaque rendering.
