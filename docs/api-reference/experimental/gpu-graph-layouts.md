...
See [GPU Primitives and Command Graphs](https://luma.gl/docs/api-reference/experimental/gpu-core.md) for the underlying scheduling, typed GPU vectors, resource ownership, and explicit submission model.
