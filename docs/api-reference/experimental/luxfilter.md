...
<ExperimentalDocsTabs active="luxfilter" />

`@luma.gl/experimental/luxfilter` coordinates linked selections across GPU-resident maps,
...
LuxFilter is an experimental, renderer-independent WebGPU controller. It does not ship a dashboard
...
<DeferredLuxFilterExample embeddedHeight={900} />
...
LuxFilter is inspired by [NVIDIA RAPIDS cuXfilter](https://github.com/rapidsai/cuxfilter), whose
...
The projects solve related interaction problems in different environments. LuxFilter does not
...
underlying compute infrastructure and [GPU Coordinate Projection](/docs/api-reference/experimental/luproj)
