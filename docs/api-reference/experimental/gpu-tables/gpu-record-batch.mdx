...
<GPUTablesDocsTabs active="record-batch" />
...
batch-local [`GPUData`](/docs/api-reference/gpgpu/gpu-data) chunk per selected column,
[`GPUSchema`](/docs/api-reference/experimental/gpu-tables/gpu-schema) metadata, and buffer-layout
metadata.
