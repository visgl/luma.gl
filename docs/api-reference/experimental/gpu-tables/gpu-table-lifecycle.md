...
[Overview](https://luma.gl/docs/api-reference/experimental/gpu-tables.md)[Structure](https://luma.gl/docs/api-reference/experimental/gpu-tables/gpu-table-structure.md)[Lifecycle](https://luma.gl/docs/api-reference/experimental/gpu-tables/gpu-table-lifecycle.md)
...
See [GPUSchema](https://luma.gl/docs/api-reference/experimental/gpu-tables/gpu-schema.md) and [GPUVectorFormat](https://luma.gl/docs/api-reference/gpgpu/gpu-vector-format.md) for the type reference. A model's accepted prepared vector inputs are declared separately with [`GPUInputSchema`](https://luma.gl/docs/api-reference/experimental/gpu-tables/gpu-input-schema.md).
...
| ---------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| `GPUData`        | One GPU buffer plus row/stride metadata and buffer ownership.                                                 | [GPUData](https://luma.gl/docs/api-reference/gpgpu/gpu-data.md)                                  |
| `GPUVector`      | One logical column over ordered `GPUData[]` chunks.                                                           | [GPUVector](https://luma.gl/docs/api-reference/gpgpu/gpu-vector.md)                              |
| `GPUConstant`    | One table-wide fixed-width logical column value.                                                              | [GPUConstant](https://luma.gl/docs/api-reference/gpgpu/gpu-constant.md)                          |
| `GPURecordBatch` | One immutable preserved batch with batch-local data chunks and layout metadata.                               | [GPURecordBatch](https://luma.gl/docs/api-reference/experimental/gpu-tables/gpu-record-batch.md) |
| `GPUTable`       | Table-level owner that preserves batches, exposes aggregate vectors, and controls packing/detach/destruction. | [GPUTable](https://luma.gl/docs/api-reference/experimental/gpu-tables/gpu-table.md)              |
| `GPUSchema`      | Selected-column metadata with `GPUVectorFormat` fields.                                                       | [GPUSchema](https://luma.gl/docs/api-reference/experimental/gpu-tables/gpu-schema.md)            |
| `GPUInputSchema` | Runtime declaration of required and optional `GPUVector` model inputs.                                        | [GPUInputSchema](https://luma.gl/docs/api-reference/experimental/gpu-tables/gpu-input-schema.md) |
...
The object-model point is that planning is metadata-only. The planner does not create `GPUData`, `GPUVector`, or `GPUTable` instances. See [`GPUTableBufferPlanner`](https://luma.gl/docs/api-reference/experimental/gpu-tables/gpu-table-buffer-planner.md) for modes, options, and output shapes.
...
* [GPUVector](https://luma.gl/docs/api-reference/gpgpu/gpu-vector.md)
* [GPUData](https://luma.gl/docs/api-reference/gpgpu/gpu-data.md)
* [GPUSchema](https://luma.gl/docs/api-reference/experimental/gpu-tables/gpu-schema.md)
* [GPUInputSchema](https://luma.gl/docs/api-reference/experimental/gpu-tables/gpu-input-schema.md)
* [GPUVectorFormat](https://luma.gl/docs/api-reference/gpgpu/gpu-vector-format.md)
