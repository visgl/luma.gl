...
For refractive surfaces and transparency composition, see [`glassMaterial`](https://luma.gl/docs/api-reference/experimental/glass-material.md) and [Glass Effects](https://luma.gl/docs/api-guide/shaders/glass-effects.md).
