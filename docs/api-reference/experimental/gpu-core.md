...
* [Vector Field Lab](https://luma.gl/examples/showcase/vector-field-lab) composes analytic volume sampling with 3D gradient, divergence, curl, and Laplacian nodes and ray marches their outputs directly.
...
| Selection and compaction  | [`GPUScan`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-scan.md), `GPUScanUint64` for exceptional split-word inclusive 64-bit prefixes, [`GPUGallopingSearch`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-galloping-search.md), [`GPUCompaction`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-compaction.md), [`GPUFlagOffsets`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-flag-offsets.md), [`GPUSegmentOffsets`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-segment-offsets.md), [`GPUSegmentedLayout`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-segmented-layout.md), `GPUIndexedRangeCompaction`, `GPUPartitionedIndexedRangeCompaction`, `GPUChunkedIndexedScatter`, `GPUTextSelection`, [`GPUMask`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-mask.md), [`GPUVisibilityWorkflow`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-visibility-workflow.md), [`GPUVirtualGeometrySelection`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-virtual-geometry-selection.md) |
...
| Sampled fields            | [GPUFiniteDifference2D and GPUFiniteDifference3D](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-finite-differences.md) for gradient, divergence, curl, and Laplacian evaluation with explicit spacing, boundary policy, and independent input/output partitions                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
