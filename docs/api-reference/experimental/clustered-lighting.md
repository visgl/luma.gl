...
* [Deferred Lighting](https://luma.gl/docs/api-reference/experimental/deferred-lighting.md) documents the shared G-buffer material contract and the fixed 64-light baseline resolve.
* [GBuffer](https://luma.gl/docs/api-reference/experimental/g-buffer.md) owns the scene MRT attachments.
* [Shader Passes](https://luma.gl/docs/api-guide/shaders/shader-passes.md) explains ordered fullscreen composition.
