...
The same constant table is also documented in the [WebGL constants reference](https://luma.gl/docs/api-reference/webgl/constants.md).
...
* [`@luma.gl/webgl`](https://luma.gl/docs/api-reference/webgl.md)
* [`@luma.gl/core`](https://luma.gl/docs/api-reference/core.md)
* [WebGPU versus WebGL](https://luma.gl/docs/api-guide/background/webgpu-vs-webgl.md)
