...
| [`@luma.gl/anari-js`][anari-js]       | Experimental | ANARI-inspired retained scene objects, instanced rendering, lights, materials, and HDR.        |
...
- [`@luma.gl/anari-js`][anari-js] for experimental ANARI-inspired declarative scenes, retained rendering, and instancing.
...
[anari-js]: /docs/api-reference/anari-js
