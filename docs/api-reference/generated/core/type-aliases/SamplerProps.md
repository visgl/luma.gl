...
> **SamplerProps** = [`ResourceProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/ResourceProps.md) & `object`
...
> `optional` **compare?**: [`CompareFunction`](https://luma.gl/docs/api-reference/generated/core/type-aliases/CompareFunction.md)
