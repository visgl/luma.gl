...
> **BufferProps** = [`ResourceProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/ResourceProps.md) & `object`
...
> `optional` **onMapped?**: [`BufferMapCallback`](https://luma.gl/docs/api-reference/generated/core/type-aliases/BufferMapCallback.md)<`void`>
