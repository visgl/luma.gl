...
> **RenderPassProps** = [`ResourceProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/ResourceProps.md) & `object`
...
> `optional` **clearColor?**: `NumberArray4` | [`TypedArray`](https://luma.gl/docs/api-reference/generated/core/type-aliases/TypedArray.md) | `false`
...
> `optional` **clearColors?**: ([`TypedArray`](https://luma.gl/docs/api-reference/generated/core/type-aliases/TypedArray.md) | `false`)\[]
...
> `optional` **framebuffer?**: [`Framebuffer`](https://luma.gl/docs/api-reference/generated/core/classes/Framebuffer.md) | `null`
...
> `optional` **occlusionQuerySet?**: [`QuerySet`](https://luma.gl/docs/api-reference/generated/core/classes/QuerySet.md)

QuerySet to write begin/end timestamps to

### parameters?[​](#parameters "Direct link to parameters?")

> `optional` **parameters?**: [`RenderPassParameters`](https://luma.gl/docs/api-reference/generated/core/type-aliases/RenderPassParameters.md)

Control viewport, scissor rect, blend constant and stencil ref

### resolveTargets?[​](#resolvetargets "Direct link to resolveTargets?")

> `optional` **resolveTargets?**: ([`TextureView`](https://luma.gl/docs/api-reference/generated/core/classes/TextureView.md) | `null`)\[]
