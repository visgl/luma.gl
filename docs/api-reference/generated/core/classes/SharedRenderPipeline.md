...
Defined in: [modules/core/src/adapter/resources/shared-render-pipeline.ts:22](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/shared-render-pipeline.ts#L22)

Internal base class for backend-specific shared render-pipeline implementations. Backends may use this to share expensive linked/program state across multiple `RenderPipeline` wrappers.

## Extends[​](#extends "Direct link to Extends")

* [`Resource`](https://luma.gl/docs/api-reference/generated/core/classes/Resource.md)<[`SharedRenderPipelineProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/SharedRenderPipelineProps.md)>

## Constructors[​](#constructors "Direct link to Constructors")

### Constructor[​](#constructor "Direct link to Constructor")

> **new SharedRenderPipeline**(`device`, `props`): `SharedRenderPipeline`

Defined in: [modules/core/src/adapter/resources/shared-render-pipeline.ts:30](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/shared-render-pipeline.ts#L30)
...
Defined in: [modules/core/src/adapter/resources/shared-render-pipeline.ts:27](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/shared-render-pipeline.ts#L27)
...
Defined in: [modules/core/src/adapter/resources/shared-render-pipeline.ts:28](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/shared-render-pipeline.ts#L28)
...
> `static` **defaultProps**: `Required`<[`ResourceProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/ResourceProps.md)>
...
Defined in: [modules/core/src/adapter/resources/shared-render-pipeline.ts:23](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/shared-render-pipeline.ts#L23)
