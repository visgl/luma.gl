# Abstract Class: RenderBundle

Defined in: [modules/core/src/adapter/resources/render-bundle.ts:53](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/render-bundle.ts#L53)

Immutable reusable WebGPU render commands recorded by a [RenderBundleEncoder](https://luma.gl/docs/api-reference/generated/core/classes/RenderBundleEncoder.md).

## Remarks[​](#remarks "Direct link to Remarks")

Applications obtain a render bundle by calling [RenderBundleEncoder.finish](https://luma.gl/docs/api-reference/generated/core/classes/RenderBundleEncoder.md#finish); render bundles are not constructed directly. A render bundle inherits its encoder's `id` and `userData`, and can be replayed more than once by compatible render passes.
...
> **new RenderBundle**(`device`, `props`): `RenderBundle`

Defined in: [modules/core/src/adapter/resources/render-bundle.ts:58](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/render-bundle.ts#L58)
...
Defined in: [modules/core/src/adapter/resources/render-bundle.ts:62](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/render-bundle.ts#L62)
...
Defined in: [modules/core/src/adapter/resources/render-bundle.ts:54](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/render-bundle.ts#L54)
