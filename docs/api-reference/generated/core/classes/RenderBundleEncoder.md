...
Call [RenderBundleEncoder.finish](#finish) to create an immutable [RenderBundle](https://luma.gl/docs/api-reference/generated/core/classes/RenderBundle.md). The attachment formats and sample count supplied when creating the encoder must match every [RenderPass](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md) that executes the finished bundle.
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`constructor`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#constructor)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`destroyed`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#destroyed)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`device`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#device)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`handle`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#handle)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`id`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#id)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`props`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#props)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`userData`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#userdata)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`defaultClearColor`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#defaultclearcolor)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`defaultClearDepth`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#defaultcleardepth)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`defaultClearStencil`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#defaultclearstencil)

***

### defaultProps[​](#defaultprops "Direct link to defaultProps")

> `static` **defaultProps**: `Required`<[`RenderPassProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/RenderPassProps.md)>
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`defaultProps`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#defaultprops)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`[toStringTag]`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#tostringtag)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`isHandleBorrowed`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#ishandleborrowed)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`ownsHandle`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#ownshandle)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`attachResource`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#attachresource)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`beginOcclusionQuery`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#beginocclusionquery)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`delete`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#delete)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`destroy`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#destroy)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`destroyAttachedResource`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#destroyattachedresource)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`destroyAttachedResources`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#destroyattachedresources)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`detachResource`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#detachresource)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`draw`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#draw)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`drawIndexedIndirect`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#drawindexedindirect)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`drawIndirect`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#drawindirect)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`end`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#end)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`endOcclusionQuery`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#endocclusionquery)
...
`Iterable`<[`RenderBundle`](https://luma.gl/docs/api-reference/generated/core/classes/RenderBundle.md)>
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`executeBundles`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#executebundles)

***

### finish()[​](#finish "Direct link to finish()")

> `abstract` **finish**(): [`RenderBundle`](https://luma.gl/docs/api-reference/generated/core/classes/RenderBundle.md)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`getProps`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#getprops)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`insertDebugMarker`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#insertdebugmarker)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`popDebugGroup`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#popdebuggroup)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`pushDebugGroup`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#pushdebuggroup)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`setBindings`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#setbindings)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`setParameters`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#setparameters)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`setPipeline`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#setpipeline)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`setVertexArray`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#setvertexarray)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`toJSON`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#tojson)
...
[`RenderPass`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md).[`toString`](https://luma.gl/docs/api-reference/generated/core/classes/RenderPass.md#tostring)
