...
* [`Resource`](https://luma.gl/docs/api-reference/generated/core/classes/Resource.md)<[`BufferProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/BufferProps.md)>
...
> `static` **defaultProps**: `Required`<[`BufferProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/BufferProps.md)>
...
[`BufferMapCallback`](https://luma.gl/docs/api-reference/generated/core/type-aliases/BufferMapCallback.md)<`T`>
...
[`BufferMapCallback`](https://luma.gl/docs/api-reference/generated/core/type-aliases/BufferMapCallback.md)<`void` | `Promise`<`void`>>
