...
> `static` **defaultProps**: `Required`<[`CanvasContextProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/CanvasContextProps.md)> = `CanvasSurface.defaultProps`
