...
> `readonly` `static` **defaultProps**: `Required`<[`ShaderProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/ShaderProps.md)>
...
> **createShader**(`props`): [`Shader`](https://luma.gl/docs/api-reference/generated/core/classes/Shader.md)
...
Requests a [Shader](https://luma.gl/docs/api-reference/generated/core/classes/Shader.md) from the cache, creating a new Shader only if necessary.
...
Releases a previously-requested [Shader](https://luma.gl/docs/api-reference/generated/core/classes/Shader.md), destroying it if no users remain.
...
Returns the default ShaderFactory for the given [Device](https://luma.gl/docs/api-reference/generated/core/classes/Device.md), creating one if necessary.
