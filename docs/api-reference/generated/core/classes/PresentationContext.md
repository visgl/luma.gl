...
Defined in: [modules/core/src/adapter/presentation-context.ts:14](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/presentation-context.ts#L14)
...
[`CanvasContext`](https://luma.gl/docs/api-reference/generated/core/classes/CanvasContext.md).[`canvas`](https://luma.gl/docs/api-reference/generated/core/classes/CanvasContext.md#canvas)
...
Defined in: [modules/core/src/adapter/canvas-surface.ts:99](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/canvas-surface.ts#L99)
...
> `readonly` **props**: `Required`<[`CanvasContextProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/CanvasContextProps.md)>
...
[`CanvasContext`](https://luma.gl/docs/api-reference/generated/core/classes/CanvasContext.md).[`type`](https://luma.gl/docs/api-reference/generated/core/classes/CanvasContext.md#type)

***

### defaultProps[​](#defaultprops "Direct link to defaultProps")

> `static` **defaultProps**: `Required`<[`CanvasContextProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/CanvasContextProps.md)>

Defined in: [modules/core/src/adapter/canvas-surface.ts:81](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/canvas-surface.ts#L81)
...
> **getCurrentFramebuffer**(`options?`): [`Framebuffer`](https://luma.gl/docs/api-reference/generated/core/classes/Framebuffer.md)
...
`false` | [`TextureFormatDepthStencil`](https://luma.gl/docs/api-reference/generated/core/type-aliases/TextureFormatDepthStencil.md)
...
### present()[​](#present "Direct link to present()")

> `abstract` **present**(): `void`

Defined in: [modules/core/src/adapter/presentation-context.ts:15](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/presentation-context.ts#L15)
