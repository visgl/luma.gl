...
Defined in: [modules/core/src/adapter/resources/sampler.ts:47](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/sampler.ts#L47)

Immutable Sampler object

## Extends[​](#extends "Direct link to Extends")

* [`Resource`](https://luma.gl/docs/api-reference/generated/core/classes/Resource.md)<[`SamplerProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/SamplerProps.md)>

## Constructors[​](#constructors "Direct link to Constructors")

### Constructor[​](#constructor "Direct link to Constructor")

> **new Sampler**(`device`, `props`): `Sampler`

Defined in: [modules/core/src/adapter/resources/sampler.ts:67](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/sampler.ts#L67)
...
> `static` **defaultProps**: `Required`<[`SamplerProps`](https://luma.gl/docs/api-reference/generated/core/type-aliases/SamplerProps.md)>

Defined in: [modules/core/src/adapter/resources/sampler.ts:48](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/sampler.ts#L48)
...
Defined in: [modules/core/src/adapter/resources/sampler.ts:63](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/sampler.ts#L63)
