...
Defined in: [modules/core/src/adapter/resources/command-buffer.ts:17](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/command-buffer.ts#L17)

Represents the finished contents of a CommandEncoder.

## Remarks[​](#remarks "Direct link to Remarks")

Backends may store native command buffers or replayable command lists internally, but submission preserves recorded command ordering. A command buffer inherits its encoder's `id` and `userData`. Command buffers are immutable, are submitted once, and may be retained only for debugging or application bookkeeping.
...
> **new CommandBuffer**(`device`, `props`): `CommandBuffer`

Defined in: [modules/core/src/adapter/resources/command-buffer.ts:22](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/command-buffer.ts#L22)
...
Defined in: [modules/core/src/adapter/resources/command-buffer.ts:26](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/command-buffer.ts#L26)
...
Defined in: [modules/core/src/adapter/resources/command-buffer.ts:18](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/command-buffer.ts#L18)
