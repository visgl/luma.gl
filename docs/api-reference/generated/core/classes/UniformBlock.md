...
`TUniforms` *extends* `Record`<`string`, [`UniformValue`](https://luma.gl/docs/api-reference/generated/core/type-aliases/UniformValue.md)> = `Record`<`string`, [`UniformValue`](https://luma.gl/docs/api-reference/generated/core/type-aliases/UniformValue.md)>
...
`Record`\<keyof `TUniforms`, `Record`<`string`, [`VariableShaderType`](https://luma.gl/docs/api-reference/generated/core/type-aliases/VariableShaderType.md)>>
...
> **uniforms**: `Record`\<keyof `TUniforms`, [`UniformValue`](https://luma.gl/docs/api-reference/generated/core/type-aliases/UniformValue.md)>
...
> **getAllUniforms**(): `Record`<`string`, [`UniformValue`](https://luma.gl/docs/api-reference/generated/core/type-aliases/UniformValue.md)>
