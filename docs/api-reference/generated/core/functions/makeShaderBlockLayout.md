...
> **makeShaderBlockLayout**(`uniformTypes`, `options?`): [`ShaderBlockLayout`](https://luma.gl/docs/api-reference/generated/core/type-aliases/ShaderBlockLayout.md)
...
`Readonly`<`Record`<`string`, [`CompositeShaderType`](https://luma.gl/docs/api-reference/generated/core/type-aliases/CompositeShaderType.md)>>
