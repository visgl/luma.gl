...
These helpers operate on Apache Arrow tables, record batches, vectors, and data chunks before or alongside GPU upload. For shader-facing upload and binding workflows, see [Supported Arrow Types](https://luma.gl/docs/api-reference/arrow/supported-arrow-types.md).
