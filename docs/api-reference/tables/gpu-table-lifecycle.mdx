...
<TablesDocsTabs active="lifecycle" />
...
| `GPUConstant` | One table-wide fixed-width logical column value. | [GPUConstant](/docs/api-reference/tables/gpu-constant) |
...
| `GPUInputSchema` | Runtime declaration of required and optional `GPUVector` model inputs. | [GPUInputSchema](/docs/api-reference/tables/gpu-input-schema) |
