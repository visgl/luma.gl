---
title: luma.gl glossary
description: Plain-language definitions for the GPU, rendering, shader, and command-graph terms used throughout luma.gl.
---

# luma.gl glossary

This glossary gives luma.gl terms one canonical definition. Reference pages link here instead of
redefining the same concept differently in every module.
