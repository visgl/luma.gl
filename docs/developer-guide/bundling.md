...
* [`@luma.gl/core`](https://luma.gl/docs/api-reference/core.md), which defines the portable `Device` and resource APIs;
* [`@luma.gl/webgpu`](https://luma.gl/docs/api-reference/webgpu.md), which implements the portable subset using WebGPU; and
* [`@luma.gl/webgl`](https://luma.gl/docs/api-reference/webgl.md), which implements the portable subset using WebGL 2.
...
Current luma.gl releases do not yet expose this selector, and the prototype does not yet provide the symmetric WebGPU-only removal of GLSL. Follow the [bundle-size work tracker](https://github.com/visgl/luma.gl/issues/2852) for progress, and see [Writing Portable Shaders](https://luma.gl/docs/api-guide/shaders/writing-portable-shaders.md) for the shader authoring model.
