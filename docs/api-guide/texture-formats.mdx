...
| Can textures with the format be rendered into? I.e used as render target / color attachments? | `Device.isTextureFormatRenderable(format)` |
...
| **96-bit formats**                     |                                     |                                    |                                    |
| `rgb32float-webgl`                     | <Ft f="rgb32float-webgl" />         | <L f="rgb32float-webgl" />         | <R f="rgb32float-webgl" />         | `GL.RGB32F`, dataFormat: `GL.RGB`, types: [`GL.FLOAT`], gl2: true                                                       |
| **128-bit formats**                    |                                     |                                    |                                    |
| `rgba32uint`                           | <Ft f="rgba32uint" />               | <L f="rgba32uint" />               | <R f="rgba32uint" />               | `GL.RGBA32UI`                                                                                                           |
| `rgba32sint`                           | <Ft f="rgba32sint" />               | <L f="rgba32sint" />               | <R f="rgba32sint" />               | `GL.RGBA32I`                                                                                                            |
| `rgba32float`                          | <Ft f="rgba32float" />              | <L f="rgba32float" />              | <R f="rgba32float" />              | `GL.RGBA32F`                                                                                                            |
| **Depth and stencil formats**          |                                     |
| `stencil8`                             | <Ft f="stencil8" />                 | <L f="stencil8" />                 | <R f="stencil8" />                 | `GL.STENCIL_INDEX8`                                                                                                     |
| `depth16unorm`                         | <Ft f="depth16unorm" />             | <L f="depth16unorm" />             | <R f="depth16unorm" />             | `GL.DEPTH_COMPONENT16`                                                                                                  |
| `depth24plus`                          | <Ft f="depth24plus" />              | <L f="depth24plus" />              | <R f="depth24plus" />              | `GL.DEPTH_COMPONENT24`                                                                                                  |
| `depth24plus-stencil81`                | <Ft f="depth24plus-stencil81" />    | <L f="depth24plus-stencil81" />    | <R f="depth24plus-stencil81" />    | b: 4, gl: `GL.DEPTH24_STENCIL8`                                                                                         |
| `depth32float`                         | <Ft f="depth32float" />             | <L f="depth32float" />             | <R f="depth32float" />             | `GL.DEPTH_COMPONENT32F`                                                                                                 |
| `depth24unorm-stencil8`                | <Ft f="depth24unorm-stencil8" />    | <L f="depth24unorm-stencil8" />    | <R f="depth24unorm-stencil8" />    | `GL.DEPTH_STENCIL`, `depth24unorm-stencil8` feature                                                                     |
| `depth32float-stencil8`                | <Ft f="depth32float-stencil8" />    | <L f="depth32float-stencil8" />    | <R f="depth32float-stencil8" />    | `GL.DEPTH32F_STENCIL8`, `depth32float-stencil8` feature }                                                               |
