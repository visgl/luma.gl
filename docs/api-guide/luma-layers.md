...
4. **GPU scheduling**, if the application later adds culling, compaction, indirect drawing, and analysis, schedules those operations and their intermediate resources.
