---
title: ANARI JSON scenes
description: Validate, author, generate, animate, and import declarative ANARI scene descriptions.
---
...
<AnariGuideDocsTabs active="json-scenes" />
