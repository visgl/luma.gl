...
For scenegraph-specific guidance, see the [Scenegraph guide](https://luma.gl/docs/api-guide/engine/scenegraph.md). For bind-group ownership, see the [Bind Groups guide](https://luma.gl/docs/api-guide/gpu/gpu-bindings.md).
