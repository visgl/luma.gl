...
Import both adapters when both backends are acceptable. See [GPU initialization](https://luma.gl/docs/api-guide/gpu/gpu-initialization.md).
...
* [Core GPU programming guide](https://luma.gl/docs/api-guide/gpu.md)
* [GPU commands](https://luma.gl/docs/api-guide/gpu/gpu-commands.md)
* [Buffer reference](https://luma.gl/docs/api-reference/core/resources/buffer.md)
* [Texture reference](https://luma.gl/docs/api-reference/core/resources/texture.md)
