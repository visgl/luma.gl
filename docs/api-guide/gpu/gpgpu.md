...
This guide helps you choose between the stable `@luma.gl/gpgpu` evaluators, its experimental subpaths, Engine compute helpers, and private experimental GPU tables. It assumes familiarity with buffers and typed arrays; the [Core GPU guide](https://luma.gl/docs/api-guide/gpu.md) introduces those concepts.
...
| Several dependent WebGPU operations, indirect work, or transient reuse | [GPU Core](https://luma.gl/docs/api-reference/experimental/gpu-core.md)                             |
...
* [Choosing a GPU data-processing API](https://luma.gl/docs/api-guide/gpu/gpu-data-processing.md)
