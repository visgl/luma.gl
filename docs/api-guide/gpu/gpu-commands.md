...
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| [`CommandEncoder`](https://luma.gl/docs/api-reference/core/resources/command-encoder.md)            | Records an ordered stream of buffer and texture writes and reads, render and compute operations. |
| [`ComputePass`](https://luma.gl/docs/api-reference/core/resources/compute-pass.md)                  | Records dispatches of WebGPU compute pipelines.                                                  |
| [`RenderPass`](https://luma.gl/docs/api-reference/core/resources/render-pass.md)                    | Records draw calls into a framebuffer or the current canvas frame.                               |
| [`RenderBundleEncoder`](https://luma.gl/docs/api-reference/core/resources/render-bundle-encoder.md) | Records reusable WebGPU draw commands once for replay from a later `RenderPass`.                 |
...
### Outputs and Reuse[​](#outputs-and-reuse "Direct link to Outputs and Reuse")
...
## Passes[​](#passes "Direct link to Passes")
...
## How the Pieces Fit Together[​](#how-the-pieces-fit-together "Direct link to How the Pieces Fit Together")
...
`Device`starts or submits work

->

`CommandEncoder`records one ordered stream

->

`CommandBuffer`finished stream

->

`device.submit()`sends work to the GPU
...
`CommandEncoder` owns pass creation. `RenderBundleEncoder` is a WebGPU-only side path for recording reusable draw commands that a normal `RenderPass` later replays.
...
## Commands Outside Passes[​](#commands-outside-passes "Direct link to Commands Outside Passes")
...
## Optional Details: Backends and Data Transfers[​](#optional-details-backends-and-data-transfers "Direct link to Optional Details: Backends and Data Transfers")
...
### WebGPU and WebGL execution[​](#webgpu-and-webgl-execution "Direct link to WebGPU and WebGL execution")
...
### Resource helpers and explicit commands[​](#resource-helpers-and-explicit-commands "Direct link to Resource helpers and explicit commands")
...
### Choosing a texture upload path[​](#choosing-a-texture-upload-path "Direct link to Choosing a texture upload path")
...
* [Using GPU Buffers](https://luma.gl/docs/api-guide/gpu/gpu-buffers.md)
* [Using GPU Textures](https://luma.gl/docs/api-guide/gpu/gpu-textures.md)
* [How GPU Rendering Works](https://luma.gl/docs/api-guide/gpu/gpu-rendering.md)
* [CommandEncoder](https://luma.gl/docs/api-reference/core/resources/command-encoder.md)
* [RenderBundleEncoder](https://luma.gl/docs/api-reference/core/resources/render-bundle-encoder.md)
