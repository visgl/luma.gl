...
| [`GPUDataView`](/docs/api-reference/gpgpu/gpu-data-view) | Contiguous borrowed values | Strided borrowed child or attribute values | Contiguous borrowed values at a segment offset |
