...
| `device.createRenderBundleEncoder(props?: RenderBundleEncoderProps)` | Create a [`RenderBundleEncoder`](/docs/api-reference/core/resources/render-bundle-encoder) for reusable WebGPU render commands.                               |
