...
- [`VideoTexture`](/docs/api-reference/engine/video-texture):
  - for live `HTMLVideoElement` or `VideoFrame` bindings that should update across draws; see [Working With Video Textures](/docs/api-guide/gpu/video-textures)
- `writeData()`:
