...
Texture data can be copied between GPU and CPU and vice versa, via GPU Buffers. See [Issuing GPU Commands](/docs/api-guide/gpu/gpu-commands) for when those copies should be recorded explicitly versus issued through resource-level convenience methods.
...
- [HTML-in-Canvas](/docs/api-guide/gpu/html-in-canvas):
