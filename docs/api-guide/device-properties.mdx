import {DeviceTabs, Info, Feature as F, Limit as L, WebGLLimit as WL, WebGLExtensions} from '@luma.gl/react-website';
...
| -------------------------------------- | ---------------------------------------------- | ------------------------------ |
| **Device Type**                        |
| `webgpu`                               | <F f="webgpu"/>                                | Device is using WebGPU.        |
| `webgl2`                               | <F f="webgl2"/>                                | Device is using WebGL2.        |
| `webgl`                                | <F f="webgl"/>                                 | Device is using WebGL.         |
| **Compressed Textures**                |
...
| **Textures**                           |
| `float-blend-webgl1`                   | <F f="float-blend-webgl1"/>                    | blending                       |
| `texture-srgb-webgl1`                  | <F f="texture-srgb-webgl1"/>                   | textures and renderbuffers     |
| `texture-depth-webgl1`                 | <F f="texture-depth-webgl1"/>                  | textures                       |
| `texture-float32-webgl1`               | <F f="texture-float32-webgl1"/>                | textures                       |
| `texture-float16-webgl1`               | <F f="texture-float16-webgl1"/>                | textures                       |
| `texture-filter-linear-float32-webgl`  | <F f="texture-filter-linear-float32-webgl"/>   |
| `texture-filter-linear-float16-webgl`  | <F f="texture-filter-linear-float16-webgl`" /> |
| `texture-filter-anisotropic-webgl`     | <F f="texture-filter-anisotropic-webgl"/>      |
| `texture-renderable-rgba32float-webgl` | <F f="texture-renderable-rgba32float-webgl"/>  | textures and renderbuffers     |
| `texture-renderable-float32-webgl`     | <F f="texture-renderable-float32-webgl"/>      | textures and renderbuffers     |
| `texture-renderable-float16-webgl`     | <F f="texture-renderable-float16-webgl"/>      | textures and renderbuffers     |
| **WebGPU**                             |
| `depth-clip-control`                   | <F f="depth-clip-control"/>           |                                |
| `depth24unorm-stencil8`                | <F f="depth24unorm-stencil8"/>        | `UNSIGNED_INT_24_8_WEBGL`      |
| `depth32float-stencil8`                | <F f="depth32float-stencil8"/>                 |                                |
| `timestamp-query`                      | <F f="timestamp-query"/>                       |                                |
| `indirect-first-instance`              | <F f="indirect-first-instance"/>               |                                |
| **WebGL**                              |
| `timer-query-webgl`                    | <F f="timer-query-webgl"/>                     | GPU timer support              |
| **WebGL1**                             |
| `instanced-rendering-webgl1`           | <F f="instanced-rendering-webgl1"/>            |
| `multiple-render-targets-webgl1`       | <F f="multiple-render-targets-webgl1"/>        |
| `index-uint32-webgl1`                  | <F f="index-uint32-webgl1"/>                   |
| `blend-minmax-webgl1`                  | <F f="blend-minmax-webgl1"/>                   | blending                       |
| **GLSL**                               |
