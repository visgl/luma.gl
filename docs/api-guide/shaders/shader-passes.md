...
| [`ShaderPassPipeline`](https://luma.gl/docs/api-reference/shadertools/shader-pass.md#shaderpasspipeline) | Chains existing passes with named intermediate render targets.                                         |
