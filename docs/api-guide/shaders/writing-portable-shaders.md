...
For exact WGSL rules, see [`WGSL Support`](https://luma.gl/docs/api-reference/shadertools/wgsl-support.md). For render model props, see [`Model`](https://luma.gl/docs/api-reference/engine/model.md). For a working dual-backend example, see the [Shader Plugins tutorial](https://luma.gl/docs/tutorials/shader-plugins.md).
