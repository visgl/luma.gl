...
For exact hook, injection, and plugin fields, see [`ShaderAssembler`](https://luma.gl/docs/api-reference/shadertools/shader-assembler.md) and [`ShaderPlugin`](https://luma.gl/docs/api-reference/shadertools/shader-plugin.md). For runnable examples, see [Shader Hooks](https://luma.gl/docs/tutorials/shader-hooks.md) and [Shader Plugins](https://luma.gl/docs/tutorials/shader-plugins.md). The [Arrow ShaderPlugin Filtering example](https://luma.gl/examples/arrow/arrow-filtering) shows a plugin-declared scalar attribute backed by a caller-owned `GPUTable` on WebGL 2 and WebGPU.
