...
- **Optional WebGPU mipmaps** - WebGPU mipmap generation is available through `@luma.gl/webgpu/mipmaps` and can be supplied as an explicit device capability, keeping its render and compute pipelines out of applications that do not generate mipmaps.
