...
You used per-vertex and per-instance buffers in one model. Continue with [Shader Modules](https://luma.gl/docs/tutorials/shader-modules.md) to package shader behavior for reuse, or [Lighting](https://luma.gl/docs/tutorials/lighting.md) to apply that composition to materials.
