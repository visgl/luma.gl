...
The revived [External WebGL Context example](/examples/integrations/external-context) renders a luma.gl overlay driven by MapLibre's WebGL render loop and uses the `webgl2Adapter.attach` API to keep both frameworks in sync.
