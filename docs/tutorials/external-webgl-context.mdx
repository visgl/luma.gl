...
This example uses [CARTO basemaps](https://github.com/CartoDB/basemap-styles) so you do not need a Mapbox access token, but you can still provide one if you use a Mapbox-hosted style elsewhere in your application.
