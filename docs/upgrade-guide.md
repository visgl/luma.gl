...
- `ShaderAssembler.getDefaultShaderAssembler()` has been removed. Create a
  `GLSLShaderAssembler` or `WGSLShaderAssembler` and pass it explicitly to
  `Model`, `Computation`, or direct shader assembly calls.
