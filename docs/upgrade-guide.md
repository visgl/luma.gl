...
* Scenegraph creation API has been improved, see [`createScenegraphsFromGLTF()`](https://luma.gl/docs/api-reference/gltf.md).
...
| ----------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| `luma.registerDevices()`      | Deprecated | [`luma.registerAdapters()`](https://luma.gl/docs/api-reference/core/luma.md#lumaregisteradapters).                                | Adapters provide a cleaner way to work with GPU backends.                        |
| `DeviceProps.canvas`          | Moved      | [`DeviceProps.createCanvasContext`](https://luma.gl/docs/api-reference/core/canvas-context.md#canvascontextprops).                | Move canvas related props to `props.createCanvasContext: {}`.                    |
...
| `DeviceProps.break`           | Removed    | —                                                                                                                                 | Use an alternative [debugger](https://luma.gl/docs/developer-guide/debugging.md) |
