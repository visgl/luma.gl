  ...
  <section className="luma-onboarding__section" aria-labelledby="luma-onboarding-packages">
    ...
    <div className="luma-onboarding__feature-grid">
      <Link
        ...
        to="/examples/showcase/gaussian-splats"
      >
        <OnboardingPoster
        ...
        <div className="luma-onboarding__feature-content">
          ...
          <p className="luma-onboarding__feature-description">
            {'Stream captured 3D worlds with HDR color, depth-sorted transparency, and portable GPU rendering.'}
          </p>
          <span className="luma-onboarding__feature-link">Explore the renderer →</span>
        </div>
      </Link>

      <Link
        className="luma-onboarding__feature luma-onboarding__feature--anari"
        to="/examples/experimental/anari-playground"
      >
        <OnboardingPoster
        ...
        />
        <div className="luma-onboarding__feature-content">
          <span className="luma-onboarding__feature-package">@luma.gl/anari</span>
      ...
      >
        <OnboardingPoster
          alt="A dense interactive trace processed entirely through a GPU command graph"
          className="luma-onboarding__feature-image"
          image="experimental/gpu-trace-viewer.jpg"
        />
        <div className="luma-onboarding__feature-content">
          <span className="luma-onboarding__feature-package">GPU Command Graph</span>
          <h3 className="luma-onboarding__feature-title">GPU Graph</h3>
          <p className="luma-onboarding__feature-description">
            {'Compose culling, sorting, compute, and rendering without moving your data off the GPU.'}
          </p>
          <span className="luma-onboarding__feature-link">See the graph in action →</span>
        </div>
      </Link>
    </div>
  </section>
