...
| Single-level modularity optimization | Experimental | WebGPU | `@luma.gl/experimental/lugraph` | Improve weighted community partitions through bounded best-gain moves, empty-label splits, and stable tie-breaking; weighted floating-point rounding can vary across runs or devices. |
