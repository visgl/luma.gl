...
| Screen-space crowd level of detail | Opportunity | WebGPU + WebGL2 | `@luma.gl/gltf` | Authored `MSFT_lod` fixtures are available; per-actor coverage selection, culling, and GPU-driven LOD draws are not implemented. |
