...
export default {
  Instancing: {demo: Instancing, path: 'examples/core/instancing/'},
  Cubemap: {demo: Cubemap, path: 'examples/core/cubemap/'},
  // CustomPicking: {}
  // DeferredRendering: {}
  Mandelbrot: {demo: Mandelbrot, path: 'examples/core/mandelbrot/'},
  ...
  Lesson02: {demo: Lesson02, path: 'examples/lessons/02/'},
  Lesson03: {demo: Lesson03, path: 'examples/lessons/03/'},
  Lesson04: {demo: Lesson04, path: 'examples/lessons/04/'},
  Lesson05: {demo: Lesson05, path: 'examples/lessons/05/'},
  Lesson06: {demo: Lesson06, path: 'examples/lessons/06/'},
  Lesson07: {demo: Lesson07, path: 'examples/lessons/07/'},
  Lesson08: {demo: Lesson08, path: 'examples/lessons/08/'},
  Lesson09: {demo: Lesson09, path: 'examples/lessons/09/'},
  Lesson10: {demo: Lesson10, path: 'examples/lessons/10/'},
  Lesson11: {demo: Lesson11, path: 'examples/lessons/11/'},
  Lesson12: {demo: Lesson12, path: 'examples/lessons/12/'},
  Lesson13: {demo: Lesson13, path: 'examples/lessons/13/'},
  Lesson14: {demo: Lesson14, path: 'examples/lessons/14/'},
  Lesson15: {demo: Lesson15, path: 'examples/lessons/15/'},
  Lesson16: {demo: Lesson16, path: 'examples/lessons/16/'},
}
