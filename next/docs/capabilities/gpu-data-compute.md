...
This matrix groups the GPU-resident data and analytical capabilities that compose across luma.gl. Return to the [capabilities overview](https://luma.gl/next/docs/capabilities.md) for rendering and visualization features.
...
See [GPU table structure and lifecycle](https://luma.gl/next/docs/api-reference/experimental/gpu-tables.md).
...
See [supported Arrow types and representations](https://luma.gl/next/docs/api-reference/arrow.md).
...
See [GPU operations and custom evaluation](https://luma.gl/next/docs/api-reference/gpgpu.md).

### GPU command graphs and execution[​](#gpu-command-graphs-and-execution "Direct link to GPU command graphs and execution")
...
See [GPU command graphs](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-command-graph.md).

### Parallel algorithms and GPU-native queries[​](#parallel-algorithms-and-gpu-native-queries "Direct link to Parallel algorithms and GPU-native queries")
...
See [GPU primitive documentation](https://luma.gl/next/docs/api-reference/experimental/gpu-core.md).
...
The `@luma.gl/experimental/gpu-dataframe` entry point is private and experimental; its graph-native operations are implemented, but non-unique, outer, or multi-key joins, temporal windows, and cross-batch global ordering remain opportunities. See [GPU command graphs and reusable primitives](https://luma.gl/next/docs/api-reference/experimental/gpu-core.md).

### GPU graph analytics and layout[​](#gpu-graph-analytics-and-layout "Direct link to GPU graph analytics and layout")
...
Read the [GPU-resident graph analytics reference](https://luma.gl/next/docs/api-reference/experimental/gpu-graph.md), the [interactive GPU Graph explorer](https://luma.gl/next/examples/experimental/gpu-graph-explorer), or the [deck.gl graph explorer](https://luma.gl/next/examples/deck/gpu-graph-explorer).

The [Graph Data Council (GDC)](https://ldbcouncil.org/), formerly the Linked Data Benchmark Council, maintains the [LDBC Graphalytics benchmark](https://ldbcouncil.org/benchmarks/graphalytics/). Its formal reference datasets, correctness outputs, driver, and competition rules are separate from GPU Graph's local demonstrations. Structural core numbers, modularity scoring, and single-level community optimization go beyond its six standardized workload families.
...
Start with the [GPURaster concepts and execution guide](https://luma.gl/next/docs/api-reference/experimental/gpu-raster/concepts.md), read the [GPURaster API reference](https://luma.gl/next/docs/api-reference/experimental/gpu-raster.md), or experiment with the [Satellite Raster Lab](https://luma.gl/next/examples/showcase/raster-lab).
...
Try [Million-Row Crossfilter](https://luma.gl/next/examples/showcase/million-row-crossfilter), [Billion-Point Spatial Atlas](https://luma.gl/next/examples/showcase/billion-point-spatial-atlas), [GPU data analysis](https://luma.gl/next/examples/experimental/gpu-data-analysis), and [GPU sorting](https://luma.gl/next/examples/experimental/gpu-sort). Billion-scale figures describe source corpora; the GPU-resident working set remains bounded.

## Related pages[​](#related-pages "Direct link to Related pages")

* [GPGPU programming](https://luma.gl/next/docs/api-guide/gpu/gpgpu.md)
