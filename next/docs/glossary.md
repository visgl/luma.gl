...
* [Core GPU programming](https://luma.gl/next/docs/api-guide/gpu.md)
* [Shader assembly](https://luma.gl/next/docs/api-guide/shaders/shader-assembly.md)
* [GPU Core concepts](https://luma.gl/next/docs/api-reference/experimental/gpu-core/concepts.md)
