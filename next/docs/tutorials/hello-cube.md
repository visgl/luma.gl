...
You combined geometry, asynchronous texture data, bindings, uniforms, and depth state in one reusable model. Next, [Hello Instancing](https://luma.gl/next/docs/tutorials/hello-instancing.md) draws many objects with one model and one draw call.
