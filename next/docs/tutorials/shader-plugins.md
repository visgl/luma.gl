...
For a plugin that declares an Arrow-backed scalar input and updates only `ShaderInputs` as its range changes, see [Arrow ShaderPlugin Filtering](https://luma.gl/next/examples/arrow/arrow-filtering).
