...
Treat redraw as invalidation, not permission to render forever. See [Redraw detection](https://luma.gl/next/docs/api-guide/engine/redraw.md).
...
* [Engine programming guide](https://luma.gl/next/docs/api-guide/engine.md)
* [`Model`](https://luma.gl/next/docs/api-reference/engine/model.md)
* [`ShaderInputs`](https://luma.gl/next/docs/api-reference/engine/shader-inputs.md)
