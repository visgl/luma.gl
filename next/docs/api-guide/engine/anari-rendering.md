...
This guide explains the complete application workflow, object lifecycle, animation, HDR configuration, batching strategy, and current proof-of-concept limitations. For exact signatures and parameter defaults, see the [`@luma.gl/scene` API reference](https://luma.gl/next/docs/api-reference/scene.md).

For a function-by-function comparison with the Khronos ANARI 1.1 C API and a conceptual THREE.js migration table, see [ANARI C API and THREE.js Mapping](https://luma.gl/next/docs/api-reference/scene/anari-api-mapping.md).
...
| Goal                                                                | Continue with                                                                                  |
| ------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| Create, commit, render, resize, and animate a retained scene        | [Build an ANARI scene](https://luma.gl/next/docs/api-guide/engine/anari-first-scene.md)   |
| Understand forward, deferred, and graph-based ray-tracing renderers | [Renderer architecture](https://luma.gl/next/docs/api-guide/engine/anari-architecture.md) |
| Validate, author, generate, animate, and import scene descriptions  | [JSON scenes](https://luma.gl/next/docs/api-guide/engine/anari-json-scenes.md)            |
| Look up exact object, schema, and renderer contracts                | [ANARI API reference](https://luma.gl/next/docs/api-reference/scene.md)                   |
...
For exact supported parameters and defaults, continue to the [`@luma.gl/scene` API reference](https://luma.gl/next/docs/api-reference/scene.md).

## Related pages[​](#related-pages "Direct link to Related pages")

* [Engine programming](https://luma.gl/next/docs/api-guide/engine.md)
* [How luma.gl fits together](https://luma.gl/next/docs/api-guide/luma-layers.md)
* [Experimental renderers](https://luma.gl/next/docs/api-reference/experimental.md)
