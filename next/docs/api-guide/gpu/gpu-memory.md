...
Memory on GPU is managed through [Buffer](https://luma.gl/next/docs/api-guide/gpu/gpu-buffers.md) and [Texture](https://luma.gl/next/docs/api-guide/gpu/gpu-textures.md) resources.
...
For how columns and rows can be arranged inside buffers, see [GPU memory layouts](https://luma.gl/next/docs/api-guide/gpu/gpu-memory-layouts.md).

## Memory Upload Considerations[​](#memory-upload-considerations "Direct link to Memory Upload Considerations")
...
## Memory Operation Synchronization[​](#memory-operation-synchronization "Direct link to Memory Operation Synchronization")
...
## Synchronous Reads[​](#synchronous-reads "Direct link to Synchronous Reads")
