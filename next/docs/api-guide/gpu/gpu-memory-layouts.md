...
| [`GPUDataView`](https://luma.gl/next/docs/api-reference/gpgpu/gpu-data-view.md) | Contiguous borrowed values    | Strided borrowed child or attribute values         | Contiguous borrowed values at a segment offset |
