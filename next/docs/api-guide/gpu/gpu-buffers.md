...
See also [Issuing GPU Commands](https://luma.gl/next/docs/api-guide/gpu/gpu-commands.md) for guidance on when buffer operations should use immediate resource helpers versus explicit command encoding.
...
See [Device Limits](https://luma.gl/next/docs/api-reference/core/device-limits.md) for the complete portable limit surface.
