...
| ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| [`CommandEncoder`](https://luma.gl/next/docs/api-reference/core/resources/command-encoder.md)            | Records an ordered stream of buffer and texture writes and reads, render and compute operations. |
| [`ComputePass`](https://luma.gl/next/docs/api-reference/core/resources/compute-pass.md)                  | Records dispatches of WebGPU compute pipelines.                                                  |
| [`RenderPass`](https://luma.gl/next/docs/api-reference/core/resources/render-pass.md)                    | Records draw calls into a framebuffer or the current canvas frame.                               |
| [`RenderBundleEncoder`](https://luma.gl/next/docs/api-reference/core/resources/render-bundle-encoder.md) | Records reusable WebGPU draw commands once for replay from a later `RenderPass`.                 |
...
* [Using GPU Buffers](https://luma.gl/next/docs/api-guide/gpu/gpu-buffers.md)
* [Using GPU Textures](https://luma.gl/next/docs/api-guide/gpu/gpu-textures.md)
* [How GPU Rendering Works](https://luma.gl/next/docs/api-guide/gpu/gpu-rendering.md)
* [CommandEncoder](https://luma.gl/next/docs/api-reference/core/resources/command-encoder.md)
* [RenderBundleEncoder](https://luma.gl/next/docs/api-reference/core/resources/render-bundle-encoder.md)
