...
## Uniform Buffers[​](#uniform-buffers "Direct link to Uniform Buffers")

The recommended, portable method of providing uniform information to a program is through a set of uniform buffers.
...
## "Free" Uniforms[​](#free-uniforms "Direct link to \"Free\" Uniforms")
