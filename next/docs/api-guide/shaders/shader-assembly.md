...
| ------------------------- | -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Application shader source | The shader entry points and primary flow.                                                                      | The WGSL `source` string or GLSL `vs`/`fs` strings supplied by the application.               | [`Model`](https://luma.gl/next/docs/api-reference/engine/model.md)                                                |
| `ShaderInputs`            | Module props, uniforms, and bindings after assembly.                                                           | Updating typed module props and explicit resource bindings after source assembly.             | [`ShaderInputs`](https://luma.gl/next/docs/api-reference/engine/shader-inputs.md)                                 |
| `ShaderModule`            | Reusable WGSL/GLSL source, uniform descriptors, bindings, dependencies, and optional injections.               | Importing a static shader library such as picking, lighting, projection, or a helper library. | [`ShaderModule`](https://luma.gl/next/docs/api-reference/shadertools/shader-module.md)                            |
| `ShaderPlugin`            | Reusable modules, defines, shader-facing vertex inputs, and named injections resolved for one shader language. | Attaching a dynamic, optional shader extension to a `Model` or `Computation`.                 | [`ShaderPlugin`](https://luma.gl/next/docs/api-reference/shadertools/shader-plugin.md)                            |
| Shader dependency         | Module ordering.                                                                                               | Bringing required modules in before a module that calls them.                                 | [`ShaderModule.dependencies`](https://luma.gl/next/docs/api-reference/shadertools/shader-module.md#fields)        |
| Define                    | Conditional source selection.                                                                                  | Backend or feature switches evaluated before assembly.                                        | [`WGSL Support`](https://luma.gl/next/docs/api-reference/shadertools/wgsl-support.md)                             |
| Shader hook               | A named callback emitted by the assembler and called by base shader source.                                    | A deliberate extension point such as `OFFSET_POSITION` or `FILTER_COLOR`.                     | [`ShaderAssembler`](https://luma.gl/next/docs/api-reference/shadertools/shader-assembler.md#hooks-and-injections) |
| Injection                 | Ordered source inserted at a named hook or standard anchor.                                                    | Adding declarations or small flow changes without copying the base shader.                    | [`ShaderAssembler`](https://luma.gl/next/docs/api-reference/shadertools/shader-assembler.md#hooks-and-injections) |
...
For the authoring choices behind these extension points, continue with [Writing Customizable Shaders](https://luma.gl/next/docs/api-guide/shaders/writing-customizable-shaders.md). For exact descriptor fields and examples, use the [`ShaderModule`](https://luma.gl/next/docs/api-reference/shadertools/shader-module.md), [`ShaderPlugin`](https://luma.gl/next/docs/api-reference/shadertools/shader-plugin.md), and [`ShaderAssembler`](https://luma.gl/next/docs/api-reference/shadertools/shader-assembler.md) reference pages.
