...
One goal of luma.gl is to provide a fairly small, relatively un-opinionated, optional 3D engine. The luma.gl engine is intentionally separated from the core GPU API library:
