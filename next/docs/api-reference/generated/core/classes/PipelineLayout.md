...
Defined in: [modules/core/src/adapter/resources/pipeline-layout.ts:14](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/pipeline-layout.ts#L14)

Immutable PipelineLayout object

## Extends[​](#extends "Direct link to Extends")

* [`Resource`](https://luma.gl/next/docs/api-reference/generated/core/classes/Resource.md)<[`PipelineLayoutProps`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/PipelineLayoutProps.md)>

## Constructors[​](#constructors "Direct link to Constructors")

### Constructor[​](#constructor "Direct link to Constructor")

> **new PipelineLayout**(`device`, `props`): `PipelineLayout`

Defined in: [modules/core/src/adapter/resources/pipeline-layout.ts:19](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/pipeline-layout.ts#L19)
...
[`PipelineLayoutProps`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/PipelineLayoutProps.md)
...
> `static` **defaultProps**: `Required`<[`PipelineLayoutProps`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/PipelineLayoutProps.md)>

Defined in: [modules/core/src/adapter/resources/pipeline-layout.ts:23](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/pipeline-layout.ts#L23)
...
Defined in: [modules/core/src/adapter/resources/pipeline-layout.ts:15](https://github.com/visgl/luma.gl/blob/master/modules/core/src/adapter/resources/pipeline-layout.ts#L15)
