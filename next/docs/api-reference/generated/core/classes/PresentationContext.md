...
[`CanvasContext`](https://luma.gl/next/docs/api-reference/generated/core/classes/CanvasContext.md).[`canvas`](https://luma.gl/next/docs/api-reference/generated/core/classes/CanvasContext.md#canvas)
...
[`CanvasContext`](https://luma.gl/next/docs/api-reference/generated/core/classes/CanvasContext.md).[`type`](https://luma.gl/next/docs/api-reference/generated/core/classes/CanvasContext.md#type)

***

### defaultProps[​](#defaultprops "Direct link to defaultProps")

> `static` **defaultProps**: `Required`<[`CanvasContextProps`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/CanvasContextProps.md)>
