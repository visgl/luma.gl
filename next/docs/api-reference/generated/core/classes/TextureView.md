...
* [`Resource`](https://luma.gl/next/docs/api-reference/generated/core/classes/Resource.md)<[`TextureViewProps`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/TextureViewProps.md)>
...
[`ResourceProps`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/ResourceProps.md) & `object` & `object`
...
> `abstract` **texture**: [`Texture`](https://luma.gl/next/docs/api-reference/generated/core/classes/Texture.md)
...
> `static` **defaultProps**: `Required`<[`TextureViewProps`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/TextureViewProps.md)>
