...
> **CreateDeviceProps** = `object` & [`DeviceProps`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/DeviceProps.md)
...
> `optional` **adapters?**: [`Adapter`](https://luma.gl/next/docs/api-reference/generated/core/classes/Adapter.md)\[]
