...
> **RenderPipelineProps** = [`ResourceProps`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/ResourceProps.md) & `object`
...
> `optional` **\_sharedRenderPipeline?**: [`SharedRenderPipeline`](https://luma.gl/next/docs/api-reference/generated/core/classes/SharedRenderPipeline.md)

Internal hook for backend-specific shared pipeline implementations.

### ~~bindGroups?~~[​](#bindgroups "Direct link to bindgroups")

> `optional` **bindGroups?**: [`BindingsByGroup`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/BindingsByGroup.md)
...
> `optional` **bindings?**: [`Bindings`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/Bindings.md)
...
> `optional` **bufferLayout?**: [`BufferLayout`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/BufferLayout.md)\[]
...
> `optional` **colorAttachmentFormats?**: ([`TextureFormatColor`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/TextureFormatColor.md) | `null`)\[]
...
> `optional` **depthStencilAttachmentFormat?**: [`TextureFormatDepthStencil`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/TextureFormatDepthStencil.md)
...
> `optional` **fs?**: [`Shader`](https://luma.gl/next/docs/api-reference/generated/core/classes/Shader.md) | `null`
...
> `optional` **shaderLayout?**: [`ShaderLayout`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/ShaderLayout.md) | `null`
...
> `optional` **vs?**: [`Shader`](https://luma.gl/next/docs/api-reference/generated/core/classes/Shader.md) | `null`
