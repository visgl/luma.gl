...
> **RenderBundleEncoderProps** = [`ResourceProps`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/ResourceProps.md) & `object`
...
Properties used to configure a [RenderBundleEncoder](https://luma.gl/next/docs/api-reference/generated/core/classes/RenderBundleEncoder.md).
...
> `optional` **depthStencilAttachmentFormat?**: [`TextureFormatDepthStencil`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/TextureFormatDepthStencil.md) | `false`
