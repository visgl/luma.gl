...
> `optional` **data?**: [`ExternalImage`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/ExternalImage.md) | [`TypedArray`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/TypedArray.md) | `null`
...
> `optional` **format?**: [`TextureFormat`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/TextureFormat.md)
...
> `optional` **view?**: [`TextureViewProps`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/TextureViewProps.md)
