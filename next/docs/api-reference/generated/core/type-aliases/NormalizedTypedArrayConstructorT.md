...
> **NormalizedTypedArrayConstructorT**<`T`> = `T` *extends* `"unorm8"` | `"snorm8"` | `"unorm16"` | `"snorm16"` ? `Float32ArrayConstructor` : [`TypedArrayConstructorT`](https://luma.gl/next/docs/api-reference/generated/core/type-aliases/TypedArrayConstructorT.md)<`T`>
