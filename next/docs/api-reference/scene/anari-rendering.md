...
## `ANARICamera`[​](#anaricamera "Direct link to anaricamera")
...
### Camera parameters[​](#camera-parameters "Direct link to Camera parameters")
...
### Perspective camera[​](#perspective-camera "Direct link to Perspective camera")
...
### Orthographic camera[​](#orthographic-camera "Direct link to Orthographic camera")
...
## `ANARIRenderer`[​](#anarirenderer "Direct link to anarirenderer")
...
### Renderer parameters[​](#renderer-parameters "Direct link to Renderer parameters")
...
### Default renderer[​](#default-renderer "Direct link to Default renderer")
...
### Deferred renderer[​](#deferred-renderer "Direct link to Deferred renderer")
...
### Ray-tracing renderer[​](#ray-tracing-renderer "Direct link to Ray-tracing renderer")
...
For the rationale behind the TLAS/BLAS split, Morton ordering, refit policy, megakernel execution, and temporal reconstruction policy, see [ray-tracing technique background and tradeoffs](https://luma.gl/next/docs/api-guide/engine/anari-architecture.md#ray-tracing-technique-background-and-tradeoffs).

Applications can also [register custom renderer runtimes](https://luma.gl/next/docs/api-reference/scene/anari-device.md#registering-renderer-runtimes).

### Debug normals[​](#debug-normals "Direct link to Debug normals")
...
### Debug depth[​](#debug-depth "Direct link to Debug depth")
...
### Updating renderer settings[​](#updating-renderer-settings "Direct link to Updating renderer settings")
...
## `ANARIFrame`[​](#anariframe "Direct link to anariframe")
...
### Replacing world, camera, or renderer[​](#replacing-world-camera-or-renderer "Direct link to Replacing world, camera, or renderer")
...
## Shared exported types[​](#shared-exported-types "Direct link to Shared exported types")
