...
[`GPUDataView`](https://luma.gl/next/docs/api-reference/gpgpu/gpu-data-view.md) is the non-owning physical counterpart: one fixed-width format, value count, byte offset, and byte stride over any buffer-like resource.
