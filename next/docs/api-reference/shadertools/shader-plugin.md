...
For runnable examples, see [Shader Plugins](https://luma.gl/next/docs/tutorials/shader-plugins.md) and [Arrow ShaderPlugin Filtering](https://luma.gl/next/examples/arrow/arrow-filtering).
