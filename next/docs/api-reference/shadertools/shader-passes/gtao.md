...
* [SSAO](https://luma.gl/next/docs/api-reference/shadertools/shader-passes/ssao.md) provides a four-pass, non-temporal ambient-occlusion path.
* [Screen-Space Global Illumination](https://luma.gl/next/docs/api-reference/shadertools/shader-passes/screen-space-global-illumination.md) adds diffuse bounced light instead of removing ambient energy.
* [Screen-Space Reflections](https://luma.gl/next/docs/api-reference/shadertools/shader-passes/screen-space-reflections.md) resolves directional specular response.
