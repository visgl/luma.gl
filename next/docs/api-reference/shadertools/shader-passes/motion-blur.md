...
* [Temporal Antialiasing](https://luma.gl/next/docs/api-reference/shadertools/shader-passes/temporal-antialiasing.md) consumes the same depth and velocity attachments.
* [Zoom Blur](https://luma.gl/next/docs/api-reference/shadertools/shader-passes/zoom-blur.md) creates an image-only radial effect without scene-authored velocity.
* [Persistence](https://luma.gl/next/docs/api-reference/shadertools/shader-passes/persistence.md) accumulates fading trails across complete frames.
