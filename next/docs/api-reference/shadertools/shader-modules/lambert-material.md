...
This `lambertMaterial` shader module provides a diffuse-only matte material model. It applies Lambert shading per fragment using the shared [`lighting`](https://luma.gl/next/docs/api-reference/shadertools/shader-modules/lighting.md) module. It is the cleanest and cheapest built-in lit material when you do not want specular highlights.
