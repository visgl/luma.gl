...
## Control Points[​](#control-points "Direct link to Control Points")
...
## Dynamic Parameters[​](#dynamic-parameters "Direct link to Dynamic Parameters")
...
However, parameters are set on the `RenderPipeline` and are immutable. (luma.gl provides a [`PipelineFactory`](https://luma.gl/next/docs/api-reference/core/pipeline-factory.md) to help applications work around this limitation.)
...
* luma.gl provides a [`PipelineFactory`](https://luma.gl/next/docs/api-reference/core/pipeline-factory.md) to help applications work around this limitation.
...
## RenderPipeline Parameters[​](#renderpipeline-parameters "Direct link to RenderPipeline Parameters")

### Assembly (Culling)[​](#assembly-culling "Direct link to Assembly (Culling)")
...
### Depth Test Parameters[​](#depth-test-parameters "Direct link to Depth Test Parameters")
...
### Multisampling[​](#multisampling "Direct link to Multisampling")
...
### Color Targets[​](#color-targets "Direct link to Color Targets")
...
Use the interactive playground to compare blend operations, source and destination factors, blend constants, and separate color and alpha output.

### Blending

[GitHub](https://github.com/visgl/luma.gl/tree/master/examples/api/blending)Info
...
The following link provides more information on [color blending](https://csawesome.runestone.academy/runestone/books/published/learnwebgl2/12_advanced_rendering/05_color_blending.html).
