...
`CommandBuffer` is an immutable recorded unit of GPU work produced by a [`CommandEncoder`](https://luma.gl/next/docs/api-reference/core/resources/command-encoder.md). Submit it through the owning `Device`.
...
See [GPU commands](https://luma.gl/next/docs/api-guide/gpu/gpu-commands.md).
