...
`TextureProps` extends [`ResourceProps`](https://luma.gl/next/docs/api-reference/core/resources/resource.md#resourceprops) and accepts the following fields.
...
| `data?`      | `ExternalImage \| TypedArray \| null`                                                   | `null`                                                 | Initial pixel data. This path is deprecated in favor of [`DynamicTexture`](https://luma.gl/next/docs/api-reference/engine/dynamic-texture.md) and only supports direct image uploads.                   |
...
| `format?`    | [`TextureFormat`](https://luma.gl/next/docs/api-reference/core/texture-formats.md) | `'rgba8unorm'`                                         | The GPU format that determines channel ordering, bit depth and compression.                                                                                                                                  |
...
| `samples?`   | `number`                                                                                | backend default                                        | WebGPU sample count for a true multisampled render attachment. WebGL textures remain single-sampled; see [Antialiasing and Multisampling](https://luma.gl/next/docs/api-guide/gpu/gpu-antialiasing.md). |
...
`Texture.samples` does not provide a portable “render, resolve, then sample” workflow today. WebGL ignores it when allocating textures, and WebGPU multisampled textures need a compatible pipeline and explicit resolve path. See [Antialiasing and Multisampling](https://luma.gl/next/docs/api-guide/gpu/gpu-antialiasing.md) and [RFC #2741](https://github.com/visgl/luma.gl/issues/2741).
...
Use `readBuffer()` with an explicit destination buffer, or engine [`DynamicTexture`](https://luma.gl/next/docs/api-reference/engine/dynamic-texture.md) when you want convenience readback that allocates temporary buffers for you.
