...
For more information, see [Sampling](https://luma.gl/next/docs/api-guide/gpu/gpu-textures.md#sampling) in the API Guide.
...
### SamplerProps[​](#samplerprops "Direct link to SamplerProps")
...
Use the interactive playground to compare wrapping, filtering, mipmaps, LOD clamps, anisotropy, and depth comparison sampling.

### Texture Sampling

[GitHub](https://github.com/visgl/luma.gl/tree/master/examples/api/texture-sampling)Info
...
#### Texture Magnification Filter[​](#texture-magnification-filter "Direct link to Texture Magnification Filter")
...
#### Texture Minification Filter[​](#texture-minification-filter "Direct link to Texture Minification Filter")
...
#### Texture Mipmap Filter[​](#texture-mipmap-filter "Direct link to Texture Mipmap Filter")
...
For more information, see [GPU Textures](https://luma.gl/next/docs/api-guide/gpu/gpu-textures.md#mipmaps).

#### Texture Max Anisotropy[​](#texture-max-anisotropy "Direct link to Texture Max Anisotropy")

Controls multiple mipmap level can be consulted when texturing a pixel.

#### Texture Comparison Function[​](#texture-comparison-function "Direct link to Texture Comparison Function")
...
### `constructor(props: SamplerProps)`[​](#constructorprops-samplerprops "Direct link to constructorprops-samplerprops")
