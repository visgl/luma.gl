...
### constructor(device : WebGLDevice, props: TransformFeedbackProps)[​](#constructordevice--webgldevice-props-transformfeedbackprops "Direct link to constructor(device : WebGLDevice, props: TransformFeedbackProps)")
...
### setBuffers(buffers: Object) : void[​](#setbuffersbuffers-object--void "Direct link to setBuffers(buffers: Object) : void")
...
### begin(topology : PrimitiveTopology = 'point-list') : void[​](#begintopology--primitivetopology--point-list--void "Direct link to begin(topology : PrimitiveTopology = 'point-list') : void")
