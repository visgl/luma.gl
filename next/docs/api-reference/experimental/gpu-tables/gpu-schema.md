...
[GPUSchema](https://luma.gl/next/docs/api-reference/experimental/gpu-tables/gpu-schema.md)[GPUInputSchema](https://luma.gl/next/docs/api-reference/experimental/gpu-tables/gpu-input-schema.md)[Shader bindings](https://luma.gl/next/docs/api-reference/experimental/gpu-tables/gpu-table-shader-bindings.md)[Buffer planner](https://luma.gl/next/docs/api-reference/experimental/gpu-tables/gpu-table-buffer-planner.md)

From v9.4Experimental API

`GPUSchema` is the structural schema type used by [`GPUTable`](https://luma.gl/next/docs/api-reference/experimental/gpu-tables/gpu-table.md) and [`GPURecordBatch`](https://luma.gl/next/docs/api-reference/experimental/gpu-tables/gpu-record-batch.md).

It is a plain TypeScript type, not a class. GPU table core does not depend on Apache Arrow schema classes.

For the required and optional `GPUVector` inputs accepted by a model, see [`GPUInputSchema`](https://luma.gl/next/docs/api-reference/experimental/gpu-tables/gpu-input-schema.md).
...
* [`GPUData`](https://luma.gl/next/docs/api-reference/gpgpu/gpu-data.md) owns or borrows one buffer.
* [`GPUVector`](https://luma.gl/next/docs/api-reference/gpgpu/gpu-vector.md) owns or borrows ordered `GPUData` chunks.
* [`GPURecordBatch`](https://luma.gl/next/docs/api-reference/experimental/gpu-tables/gpu-record-batch.md) owns one batch-local `GPUData` chunk per selected column.
* [`GPUTable`](https://luma.gl/next/docs/api-reference/experimental/gpu-tables/gpu-table.md) owns preserved batches.
