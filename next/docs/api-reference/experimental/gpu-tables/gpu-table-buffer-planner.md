...
### `GPUTableBufferPlanner.getAllocationPlan(props)`[​](#gputablebufferplannergetallocationplanprops "Direct link to gputablebufferplannergetallocationplanprops")
...
### `GPUTableBufferPlanner.shouldSkipColumnBuffer(column)`[​](#gputablebufferplannershouldskipcolumnbuffercolumn "Direct link to gputablebufferplannershouldskipcolumnbuffercolumn")
...
## Planner Modes[​](#planner-modes "Direct link to Planner Modes")
...
## Column Descriptors[​](#column-descriptors "Direct link to Column Descriptors")
...
## Allocation Groups[​](#allocation-groups "Direct link to Allocation Groups")
...
## Planner Output[​](#planner-output "Direct link to Planner Output")
...
## Storage Buffer Planning[​](#storage-buffer-planning "Direct link to Storage Buffer Planning")
