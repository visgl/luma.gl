...
| Family                                                                                                              | Use it for                                                  |
| ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| [Topology](https://luma.gl/next/docs/api-reference/experimental/gpu-graph-topology.md)                         | Edge views, compressed adjacency, and degree counts.        |
| [Traversal and pathfinding](https://luma.gl/next/docs/api-reference/experimental/gpu-graph-traversal.md)       | Unweighted neighborhoods and weighted routes.               |
| [Connectivity and communities](https://luma.gl/next/docs/api-reference/experimental/gpu-graph-connectivity.md) | Components, community discovery, optimization, and quality. |
| [Metrics and ranking](https://luma.gl/next/docs/api-reference/experimental/gpu-graph-metrics.md)               | Core numbers, clustering, and PageRank.                     |
| [Layouts](https://luma.gl/next/docs/api-reference/experimental/gpu-graph-layouts.md)                           | Exact and accelerated progressive spatial layouts.          |
...
* [GPU Core overview](https://luma.gl/next/docs/api-reference/experimental/gpu-core.md)
* [Graph explorer example](https://luma.gl/next/examples/experimental/gpu-graph-explorer)
