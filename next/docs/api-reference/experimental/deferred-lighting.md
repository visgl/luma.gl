...
* [`GBuffer`](https://luma.gl/next/docs/api-reference/experimental/g-buffer.md) owns the MRT attachments and standard depth, normal, and velocity bindings.
* [Clustered Lighting](https://luma.gl/next/docs/api-reference/experimental/clustered-lighting.md) reuses the same material attachments with compute-built light lists for hundreds of local lights.
* [Shader Passes](https://luma.gl/next/docs/api-guide/shaders/shader-passes.md) explains the ordered composable render stack.
* [Advanced Effects](https://luma.gl/next/examples/experimental/advanced-effects) shows the broader scene-aware and temporal effect chain after opaque rendering.
