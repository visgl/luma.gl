...
| Define or upload a single application-owned raster                              | Raster metadata and bands in the [storage and residency reference](https://luma.gl/next/docs/api-reference/experimental/gpu-raster/operations-storage-residency.md#raster-bands-and-validity). |
...
| Look up complete constructors, format constraints, ownership, and code examples | The [GPURaster API reference](https://luma.gl/next/docs/api-reference/experimental/gpu-raster.md).                                                                                             |
...
For constructor signatures, graph examples, numerical constraints, and current feature limits, continue to the [GPURaster API reference](https://luma.gl/next/docs/api-reference/experimental/gpu-raster.md).
