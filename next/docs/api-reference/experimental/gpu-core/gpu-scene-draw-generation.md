...
See also [`GPUScene`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-scene.md), [`GPUVisibilityWorkflow`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-visibility-workflow.md), and [`DrawCommandBuffer`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/draw-command-buffer.md).
