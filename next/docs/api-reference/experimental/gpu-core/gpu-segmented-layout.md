...
**Common mistake**Use binary flags, keep segmentStartFlags\[0] zero, and consume only segmentCount + 1 segment offsets.
...
## Flag and output contract[​](#flag-and-output-contract "Direct link to Flag and output contract")
...
### Pack present values[​](#pack-present-values "Direct link to Pack present values")
...
### Retain the original payload[​](#retain-the-original-payload "Direct link to Retain the original payload")
...
### Build nested columns[​](#build-nested-columns "Direct link to Build nested columns")
...
## Costs and limits[​](#costs-and-limits "Direct link to Costs and limits")
