...
| **Reads / writes**       | Reads positions; writes cell counts, offsets, stable object IDs, accepted count, and overflow.                |
...
**Common mistake**Do not rebuild an unchanged index for every view update.
