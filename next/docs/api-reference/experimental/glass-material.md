...
For OIT composition and quality limitations, see [Transparency](https://luma.gl/next/docs/api-guide/shaders/transparency.md) and [Glass Effects](https://luma.gl/next/docs/api-guide/shaders/glass-effects.md).
