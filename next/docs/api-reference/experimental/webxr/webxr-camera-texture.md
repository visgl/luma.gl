...
`WebXRCameraTexture` is the experimental `@luma.gl/experimental` binding source for WebXR Raw Camera Access. It wraps the browser-owned camera `WebGLTexture` for one `XRView` as a borrowed read-only luma [`Texture`](https://luma.gl/next/docs/api-reference/core/resources/texture.md).
...
### `WebXRCameraTextureProps`[​](#webxrcameratextureprops "Direct link to webxrcameratextureprops")
...
### `constructor(device: Device, xrWebGLBinding: XRWebGLBinding, props?: WebXRCameraTextureProps)`[​](#constructordevice-device-xrwebglbinding-xrwebglbinding-props-webxrcameratextureprops "Direct link to constructordevice-device-xrwebglbinding-xrwebglbinding-props-webxrcameratextureprops")

Creates a WebGL-only WebXR camera binding source.

### `setView(view: XRView | null): void`[​](#setviewview-xrview--null-void "Direct link to setviewview-xrview--null-void")
...
### `resolveTextureBinding(bindingLayout: TextureBindingLayout): Texture | null`[​](#resolvetexturebindingbindinglayout-texturebindinglayout-texture--null "Direct link to resolvetexturebindingbindinglayout-texturebindinglayout-texture--null")
