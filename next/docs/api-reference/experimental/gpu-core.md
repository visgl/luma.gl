...
2. [First graph](https://luma.gl/next/docs/api-reference/experimental/gpu-core/tutorial)
3. [GPU Core cookbook](https://luma.gl/next/docs/api-reference/experimental/gpu-core/recipes)

Raw WebGPU experience**I already record compute passes**

1. [Responsibility map](https://luma.gl/next/docs/api-reference/experimental/gpu-core/tutorial#translate-familiar-webgpu-concepts)
2. [Execution model](https://luma.gl/next/docs/api-reference/experimental/gpu-core/concepts)
3. [Command graph API](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-command-graph)

Application pipeline**I need GPU-resident visualization**

1. [Selection recipe](https://luma.gl/next/docs/api-reference/experimental/gpu-core/recipes#select-compact-and-render)
2. [Indirect drawing](https://luma.gl/next/docs/api-reference/experimental/gpu-core/draw-command-buffer)
3. [Frustum example](https://luma.gl/next/examples/experimental/gpu-frustum-culling)

Data analysis**I need dataframe-style operations**

1. [Aggregation recipe](https://luma.gl/next/docs/api-reference/experimental/gpu-core/recipes#aggregate-a-selection)
2. [GPU Dataframe overview](https://luma.gl/next/docs/api-reference/experimental/gpu-dataframe)
3. [GPU Dataframe operations](https://luma.gl/next/docs/api-reference/experimental/gpu-dataframe-operations)

Reusable operation**I want to contribute a subgraph**

1. [Composition levels](https://luma.gl/next/docs/api-reference/experimental/gpu-core/concepts#composition-levels)
2. [Contributor recipe](https://luma.gl/next/docs/api-reference/experimental/gpu-core/recipes#package-a-reusable-operation)
3. [Extension contracts](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-command-graph#extension-libraries)

Diagnosis**I need to explain cost or failure**

1. [Instrumentation](https://luma.gl/next/docs/api-reference/experimental/gpu-core/concepts#instrumentation-and-autotuning)
2. [Graph inspector](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-command-graph#gpucommandgraphinspector)
3. [Validation](https://luma.gl/next/docs/api-reference/experimental/gpu-core/concepts#capacity-validation-and-failure-behavior)
...
[Open full page](https://luma.gl/next/docs/api-reference/experimental/gpu-core/tutorial.md)[View source](https://github.com/visgl/luma.gl/tree/master/website/src/components/docs/gpu-core-pipeline-tutorial.tsx)[Inspect graph](https://luma.gl/next/docs/api-reference/experimental/gpu-core/concepts.md#interactive-compiler-anatomy)
...
[Continue with the complete tutorial and WebGPU comparison →](https://luma.gl/next/docs/api-reference/experimental/gpu-core/tutorial.md)
...
See [Execution and composition](https://luma.gl/next/docs/api-reference/experimental/gpu-core/concepts.md) for resource ownership, hazard scheduling, conditions, resumable execution, budgeting, instrumentation, and autotuning. See [`GPUCommandGraph`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-command-graph.md) for the construction, compilation, and encoding API. The [GPU Core cookbook](https://luma.gl/next/docs/api-reference/experimental/gpu-core/recipes.md) maps common application outcomes to the operations that compose them.
...
* [GPU Sort](https://luma.gl/next/examples/experimental/gpu-sort) compares graph-native segmented and unsegmented GPU sorting while reporting the selected execution path and measured throughput.
* [GPU Trace Viewer](https://luma.gl/next/examples/experimental/gpu-trace-viewer) combines hierarchy, selection, indexing, aggregation, dependency traversal, picking, and indirect rendering while preserving canonical span identity.
* [GPU Data Analysis](https://luma.gl/next/examples/experimental/gpu-data-analysis) composes reductions, histograms, filtered aggregations, and grid bins.
* [GPU Frustum Culling](https://luma.gl/next/examples/experimental/gpu-frustum-culling) compacts visible scene instances and writes an indirect draw count.
* [Vector Field Lab](https://luma.gl/next/examples/showcase/vector-field-lab) composes analytic volume sampling with 3D gradient, divergence, curl, and Laplacian nodes and ray marches their outputs directly.

## Operations and API index[​](#operations-and-api-index "Direct link to Operations and API index")

| Family                    | Operations                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Graph execution           | [`GPUCommandGraph`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-command-graph.md), `CompiledGPUCommandGraph`, `GPUCommandGraphExecution`, `GPUCommandGraphExecutionBudgetController`, `GPUCommandGraphAutotuner`, `GPUCommandGraphInspector`, `GraphExternalTextureHandle`, [`GPUTextureHistory`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-texture-history.md), [`GPUReadbackRing`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-readback-ring.md), [`DrawCommandBuffer`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/draw-command-buffer.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| Selection and compaction  | [`GPUScan`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-scan.md), `GPUScanUint64` for exceptional split-word inclusive 64-bit prefixes, [`GPUGallopingSearch`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-galloping-search.md), [`GPUCompaction`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-compaction.md), [`GPUFlagOffsets`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-flag-offsets.md), [`GPUSegmentOffsets`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-segment-offsets.md), [`GPUSegmentedLayout`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-segmented-layout.md), `GPUIndexedRangeCompaction`, `GPUPartitionedIndexedRangeCompaction`, `GPUChunkedIndexedScatter`, `GPUTextSelection`, [`GPUMask`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-mask.md), [`GPUVisibilityWorkflow`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-visibility-workflow.md), [`GPUVirtualGeometrySelection`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-virtual-geometry-selection.md) |
| Hierarchies and traversal | [`GPUHierarchyLayout`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-hierarchy-layout.md), [`GPUGraphTraversal`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-graph-traversal.md), [`GPUAncestorProjection`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-ancestor-projection.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Sorting and aggregation   | [`GPUSort`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-sort.md), `GPUBatchSort`, [`GPUSegmentedSort`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-segmented-sort.md), [`GPUFFT2D`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-fft2d.md), [`GPUReduction`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-reduction.md), [`GPUHistogram`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-histogram.md), [`GPUGroupAggregation`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-group-aggregation.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Spatial indexing          | [`GPUGridBinning`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-grid-binning.md), [`GPUGridAggregation`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-grid-aggregation.md), [`GPUGridIndex`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-grid-index.md), [`GPUGridIndexQuery`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-grid-index-query.md), [`GPUPointSpatialFilter`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-point-spatial-filter.md), [`GPUBVH`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-bvh.md), [`GPUSegmentedBVH`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-segmented-bvh.md), [`GPUBVHQuery`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-bvh-query.md)                                                                                                                                                                                                                                                                                                                                 |
| GPU scenes                | [`GPUScene`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-scene.md), [scene adapters](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-scene-adapters.md), [draw generation](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-scene-draw-generation.md), [resource groups](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-scene-resource-groups.md), [`GPUIndexPickingTarget`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-index-picking-target.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Hash indexes and joins    | [`GPUHashIndex`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-hash-index.md), [`GPUBatchHashIndex`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-batch-hash-index.md), [`GPUHashJoin`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-hash-join.md), [`GPUBatchHashJoin`](https://luma.gl/next/docs/api-reference/experimental/gpu-core/gpu-batch-hash-join.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

Trace-domain algorithms are indexed from the [`@luma.gl/experimental/gpu-trace` overview](https://luma.gl/next/docs/api-reference/experimental/gpu-trace.md).
...
* [`@luma.gl/experimental/gpu-trace`](https://luma.gl/next/docs/api-reference/experimental/gpu-trace.md) adds trace semantics.
* [GPU Graph](https://luma.gl/next/docs/api-reference/experimental/gpu-graph.md) provides graph-data analytics.
* [GPU Raster](https://luma.gl/next/docs/api-reference/experimental/gpu-raster.md) provides raster and field operations.
* [GPU Dataframe](https://luma.gl/next/docs/api-reference/experimental/gpu-dataframe.md) provides dataframe-style GPU analysis.
* [`@luma.gl/gpgpu/gpu-data`](https://luma.gl/next/docs/api-reference/gpgpu/gpu-data.md) defines Arrow-independent GPU data containers.
