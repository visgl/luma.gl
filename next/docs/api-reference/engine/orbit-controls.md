...
### `roll: number`[​](#roll-number "Direct link to roll-number")
...
### `getUpDirection(): OrbitPosition`[​](#getupdirection-orbitposition "Direct link to getupdirection-orbitposition")
