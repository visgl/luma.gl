...
For the `uniformTypes` descriptor syntax that drives nested uniform handling, see [Core Shader Types](https://luma.gl/next/docs/api-reference/core/shader-types.md).
