...
![DynamicBuffer infographic showing a stable DynamicBuffer handle, replaceable backing Buffer, resize and write flow, and Model and Material integration](/next/assets/images/dynamic-buffer-infographic-20d7564b154510a7850a3e1067846e5d.png)
...
* `DynamicBuffer` is directly supported by [`Model`](https://luma.gl/next/docs/api-reference/engine/model.md) attributes, index buffers, and bindings.
