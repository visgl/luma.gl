...
For the rationale behind the TLAS/BLAS split, Morton ordering, refit policy, megakernel execution, and temporal reconstruction roadmap, see [ray-tracing technique background and tradeoffs](https://luma.gl/next/docs/api-guide/engine/anari-rendering.md#ray-tracing-technique-background-and-tradeoffs).

Applications can also [register custom renderer runtimes](https://luma.gl/next/docs/api-reference/anari/anari-device.md#registering-renderer-runtimes).
