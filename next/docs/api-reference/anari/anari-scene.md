...
## `ANARISurface`[​](#anarisurface "Direct link to anarisurface")
...
## `ANARIGroup`[​](#anarigroup "Direct link to anarigroup")
...
## `ANARIInstance`[​](#anariinstance "Direct link to anariinstance")
...
### Updating transforms[​](#updating-transforms "Direct link to Updating transforms")
...
## `ANARIWorld`[​](#anariworld "Direct link to anariworld")
...
### Replacing scene contents[​](#replacing-scene-contents "Direct link to Replacing scene contents")
...
### Instancing statistics[​](#instancing-statistics "Direct link to Instancing statistics")
...
## Scene ownership and lifecycle[​](#scene-ownership-and-lifecycle "Direct link to Scene ownership and lifecycle")
