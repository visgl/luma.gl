...
- New `PCDLoader` (#679)
- Fix unit test (#682)
- Tone down headless-gl info message. Add FAQ entry.   (#675)
- Fix VertexArray bug where indexType is undefined (#680)
- RFC: Transform - Float textures support. (#672)
- Refactor: GLBBuilder (#674)
- Small tuning of attribute creation (#677)
- loaders.gl: Add base format loaders + `smartFetch` (#670)
- Fix shader transpile in handling texture sample instructions (#649)
- Fix and enable picking and pack unit tests (#669)
- loader documentation (#658)
- Add loader module RFC (#657)
- KML loader (#667)
- Fix typo (#668)
- Handle attribute zero (#665)
- Implement allocation of constant buffers (#663)
- Buffer Cleanup (#664)
- Make ocular the default website (#662)
- Add GLB and Point Cloud Loaders to new loaders module (#659)
- Misc Vertex Array fixes. (#656)
- Fix babel gl inlining (#655)
- Attribute fixes (#652)
- Accessor cleanup (#651)
- Fix browser tests (#650)
- Add initial loaders directory (#646)
- Fix accessor instanced bug (#647)
- VertexArray refactor (#618)
- RFC update: WebGL1 support for Transform (#641)
- Pack: Add unit tests (#642)
