export const FOUNDATION_JOURNEY = [
  ...
  {id: 'gpu-core', label: 'GPU Core', summary: 'Schedule multi-stage GPU workflows when needed.', detail: 'Graphs add validation, hazard ordering, transient aliasing, indirect work, instrumentation, and resumable multi-frame execution.'}
] as const;
