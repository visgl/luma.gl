...
import {RenderLoop, AnimationLoop, makeAnimationLoop} from '@luma.gl/engine';
...
export const LumaExample: FC<LumaExampleProps> = (props) => {
  ...
  if (isBrowser()) {
    ...
    useEffect(() => {
      ...
      animationLoop = makeAnimationLoop(props.RenderLoop, {device});
  ...
  return (<div id={containerName} style={{width: 800, height: 600}} />);
    ...
    // const controls = 
    //   props.RenderLoop.info ||
    //   props.RenderLoop.getInfo?.() ||
