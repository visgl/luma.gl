...
The columns are deliberately uncompressed. The infobox reports the codecs found in page metadata,
compressed and decoded page-payload sizes, and their ratio so a regenerated Snappy or LZ4_RAW
fixture cannot silently present itself as an encoding-only comparison. Uncompressed data isolates the GPU-suitable column encodings and
