...
>
  <div>
    ...
    and stochastic reflections bounce the animated scene across polished floors, chrome accents,
    and glossy-to-mirror materials.
  </div>
</ExampleHeader>
...
- **Base Color**, **Normals**, **Roughness**, **Metallic**, **Emissive**, and **Depth** expose the
  ...
  **Reflections** isolates reflected HDR radiance, while **Reflection Confidence** makes
  screen-edge and roughness falloff visible.
