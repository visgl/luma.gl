...
>
  <div>
    ...
    participating media turns the same point lights and sun into colored atmospheric halos.
  </div>
</ExampleHeader>
...
reflections, and clustered volumetric scattering. Expand a section to adjust its quality,
transport, or temporal-history controls without scrolling through one flattened settings list.
...
- **Base Color**, **Normals**, **Roughness**, **Metallic**, **Emissive**, and **Depth** expose the
  ...
  **Reflections** isolates reflected HDR radiance, while **Reflection Confidence** makes
  ...
  participating-media in-scattering, while **Volume Transmittance** exposes atmospheric extinction.
...
extinction and an anisotropic phase function, stabilizes low-resolution in-scattering with
