...
export default (pagePath, callback) => {
  ...
  if (page.jsonName in dataPaths) {
    ...
    try {
      dataAndContext = JSON.parse(
        fs.readFileSync(`${process.cwd()}/public/static/d/${dataPaths[page.jsonName]}.json`)
      );
    } catch (e) {
  ...
  if (page.jsonName in dataPaths) {
    ...
    headComponents.push(
      <link as="fetch" rel="preload" key={dataPath} href={dataPath} crossOrigin="use-credentials" />
    );
  }
