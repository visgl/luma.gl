...
import support69 from './arrow/arrow-polygons/mobile-support';
import support70 from './arrow/arrow-geoarrow/mobile-support';
...
export const EXAMPLE_SUPPORT_REGISTRY: Readonly<Record<string, ExampleSupportDefinition>> = {
  ...
  'arrow/arrow-polygons': support69,
  'arrow/arrow-geoarrow': support70,
