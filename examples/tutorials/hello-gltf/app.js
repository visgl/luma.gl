...
import { AnimationLoopTemplate, ModelNode } from '@luma.gl/engine';
import { load } from '@loaders.gl/core';
import { createScenegraphsFromGLTF } from '@luma.gl/gltf';
import { GLTFLoader, postProcessGLTF } from '@loaders.gl/gltf';
import { Matrix4 } from '@math.gl/core';
/* eslint-disable camelcase */
const MODEL_DIRECTORY_URL = 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/Models';
...
export default class AppAnimationLoopTemplate extends AnimationLoopTemplate {
    ...
    constructor({ device, animationLoop }) {
        super();
        this.device = device;
        ...
        this.fetchModelList().then(models => {
            ...
            setModelMenu(models.map(model => model.name), currentModel, (modelName) => {
    ...
    onFinalize() {
        this.scenegraphsFromGLTF?.scenes[0].traverse(node => node.model.destroy());
    }
    onRender({ aspect, device, time }) {
...
//
function setModelMenu(items, currentItem, onMenuItemSelected) {
