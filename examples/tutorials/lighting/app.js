...
import { AnimationLoopTemplate, Model, CubeGeometry, ShaderInputs, loadImageBitmap, DynamicTexture } from '@luma.gl/engine';
...
`;
    model;
    shaderInputs = new ShaderInputs({ app, lighting, phongMaterial });
