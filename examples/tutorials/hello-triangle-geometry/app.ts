...
import {HelloTriangleGeometryInfoHtml} from './app-ui';

const {source, vs, fs} = getShaderSources();

export default class AppAnimationLoopTemplate extends AnimationLoopTemplate {
  static info = HelloTriangleGeometryInfoHtml;
