...
import { AnimationLoopTemplate, Model, BufferTransform, Swap, makeRandomGenerator } from '@luma.gl/engine';
...
`;
    ...
    instancePositionBuffers;
    instanceRotationBuffers;
    instanceColorBuffer;
    ...
    constructor({ device, width, height, animationLoop }) {
        super();
    ...
    onRender({ device, width, height, time }) {
