...
import { AnimationLoopTemplate, CubeGeometry, Model, loadImageBitmap, DynamicTexture, ShaderInputs } from '@luma.gl/engine';
...
`;
    cube;
    prism;
    roomShaderInputs = new ShaderInputs({ app });
    prismShaderInputs = new ShaderInputs({ app });
    constructor({ device }) {
        super();
    ...
    onRender({ device, aspect, tick }) {
        ...
        const eyePosition = [eyeX, eyeY, eyeZ];
