...
import { read as readKTX2, KHR_SUPERCOMPRESSION_NONE, VK_FORMAT_R8G8B8A8_SRGB, VK_FORMAT_R8G8B8A8_UNORM, VK_FORMAT_R16G16B16A16_SFLOAT, VK_FORMAT_R32G32B32A32_SFLOAT, VK_FORMAT_ASTC_4x4_SRGB_BLOCK, VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK, VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK, VK_FORMAT_BC1_RGB_SRGB_BLOCK, VK_FORMAT_BC3_SRGB_BLOCK, VK_FORMAT_BC5_UNORM_BLOCK, VK_FORMAT_BC7_SRGB_BLOCK } from 'ktx-parse';
...
`;
    ...
    model = null;
    device;
    uniformStore = new UniformStore({ app });
    constructor({ device }) {
        super();
        this.device = device;
        this.initialize();
...
function getData(container) {
    const data = container.levels[0].levelData;
