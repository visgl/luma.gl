...
import { AnimationLoopTemplate, Model, CubeGeometry, Timeline, KeyFrames, makeRandomGenerator } from '@luma.gl/engine';
...
`;
    ...
    timeSlider;
    cubes;
    globalUniformStore = new UniformStore({
        dirlight
    });
    constructor({ device, aspect, animationLoop }) {
        super();
        ...
        for (let i = 0; i < 4; ++i) {
            ...
            const cubeUniformStore = new UniformStore({ app });
