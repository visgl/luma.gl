...
`;
export async function initializeExternalWebGLContext(options = {}) {
    ...
    const resizeCanvasContext = (webglContext) => {
        if (device) {
    ...
    const customLayer = {
        ...
        render: (maplibreWebglContext, customRenderInput) => {
