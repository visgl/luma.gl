...
import {getQuantumStudioMarkup, QUANTUM_PRESET_IDENTIFIERS} from './app-ui';
...
export default class QuantumStateStudioAnimationLoopTemplate extends AnimationLoopTemplate {
  ...
  override async onInitialize({canvas}: AnimationProps): Promise<void> {
    ...
    this.root.innerHTML = getQuantumStudioMarkup();
...
function isPresetIdentifier(value: string): value is QuantumCircuitPresetIdentifier {
  return QUANTUM_PRESET_IDENTIFIERS.includes(value as QuantumCircuitPresetIdentifier);
}
