...
import { AnimationLoopTemplate, CubeGeometry, Timeline, Model, ShaderInputs, makeRandomGenerator, PickingManager, indexPicking as picking } from '@luma.gl/engine';
  ...
  `;
    ...
    pickInstance(mousePosition) {
        ...
        if (this.picker.device.type !== 'webgl') {
            this.picker.getPickInfo(mousePosition);
        }
    }
}
